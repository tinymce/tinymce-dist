...
var modern = (function () {
  ...
  var $_1pjkc5u0jjgw5pf8 = { addKeys: addKeys };
  ...
  var addContextualToolbars = function (editor) {
    ...
    var reposition = function (match, shouldShow) {
      ...
      var delta = $_2emj7yu4jjgw5pfj.getUiContainerDelta(panel).getOr({
        x: 0,
        y: 0
      });
    ...
    var bindScrollEvent = function (panel) {
      if (!scrollContainer) {
        ...
        var uiContainer_1 = $_2emj7yu4jjgw5pfj.getUiContainer(panel);
    ...
    var showContextToolbar = function (match) {
      ...
      panel = global$4.create({
        ...
        fixed: true,
        border: 1,
        items: $_3765wnu7jjgw5pfw.createToolbar(editor, match.toolbar.items),
        oncancel: function () {
          editor.focus();
        }
      });
      $_2emj7yu4jjgw5pfj.setUiContainer(editor, panel);
  ...
  var $_185r78u1jjgw5pfa = { addContextualToolbars: addContextualToolbars };
  ...
  var $_9m1dfju8jjgw5pg2 = { createMenuButtons: createMenuButtons };
  ...
  var resizeTo = function (editor, width, height) {
    ...
    $_50yayztzjjgw5pf6.fireResizeEditor(editor);
  };
  var resizeBy = function (editor, dw, dh) {
    var elm = editor.getContentAreaContainer();
    resizeTo(editor, elm.clientWidth + dw, elm.clientHeight + dh);
  };
  var $_f42v9rubjjgw5pgk = {
    resizeTo: resizeTo,
    resizeBy: resizeBy
  };
  ...
  var fireSkinLoaded$1 = function (editor) {
    var done = function () {
      ...
      $_50yayztzjjgw5pf6.fireSkinLoaded(editor);
    };
    return function () {
      if (editor.initialized) {
        done();
  ...
  var $_co2r8vuejjgw5pgq = { fireSkinLoaded: fireSkinLoaded$1 };
  ...
  var editAreaContainer = function (editor) {
    return {
      ...
      items: [
        editArea('0'),
        $_5acwapucjjgw5pgn.createSidebar(editor)
      ]
    };
  };
  var render = function (editor, theme, args) {
    ...
    if (isSkinDisabled(editor) === false && args.skinUiCss) {
      DOM$2.styleSheetLoader.load(args.skinUiCss, $_co2r8vuejjgw5pgq.fireSkinLoaded(editor));
    } else {
      $_co2r8vuejjgw5pgq.fireSkinLoaded(editor)();
    }
      ...
      items: [
        {
          ...
          items: [
            hasMenubar(editor) === false ? null : {
              type: 'menubar',
              border: '0 0 1 0',
              items: $_9m1dfju8jjgw5pg2.createMenuButtons(editor)
            },
            $_3765wnu7jjgw5pfw.createToolbars(editor, getToolbarSize(editor))
          ]
        },
        $_5acwapucjjgw5pgn.hasSidebar(editor) ? editAreaContainer(editor) : editArea('1 0 0 0')
      ]
    });
    $_2emj7yu4jjgw5pfj.setUiContainer(editor, panel);
      ...
      resizeHandleCtrl = {
        ...
        onResize: function (e) {
          if (getResize(editor) === 'both') {
            $_f42v9rubjjgw5pgk.resizeTo(editor, startSize.width + e.deltaX, startSize.height + e.deltaY);
          } else {
            $_f42v9rubjjgw5pgk.resizeTo(editor, null, startSize.height + e.deltaY);
          }
        }
      };
    }
    ...
    $_50yayztzjjgw5pf6.fireBeforeRenderUI(editor);
    ...
    $_1pjkc5u0jjgw5pf8.addKeys(editor, panel);
    $_185r78u1jjgw5pfa.addContextualToolbars(editor);
    return {
      iframeContainer: panel.find('#iframe')[0].getEl(),
      editorContainer: panel.getEl()
    };
  };
  var $_7b0uhjtvjjgw5pez = { render: render };
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_2emj7yu4jjgw5pfj.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_2emj7yu4jjgw5pfj.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_90yctbukjjgw5phk = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_2emj7yu4jjgw5pfj.getUiContainer(self$$1);
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self$$1.borderBox = $_7jd1byuqjjgw5pil.parseBox(settings.border);
      self$$1.paddingBox = $_7jd1byuqjjgw5pil.parseBox(settings.padding);
      self$$1.marginBox = $_7jd1byuqjjgw5pil.parseBox(settings.margin);
      if (settings.hidden) {
        self$$1.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_2emj7yu4jjgw5pfj.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self$$1.borderBox = self$$1.borderBox || $_7jd1byuqjjgw5pil.measureBox(elm, 'border');
      self$$1.paddingBox = self$$1.paddingBox || $_7jd1byuqjjgw5pil.measureBox(elm, 'padding');
      self$$1.marginBox = self$$1.marginBox || $_7jd1byuqjjgw5pil.measureBox(elm, 'margin');
  ...
  var render$1 = function (editor, theme, args) {
    ...
    if (isSkinDisabled(editor) === false && args.skinUiCss) {
      DOM.styleSheetLoader.load(args.skinUiCss, $_co2r8vuejjgw5pgq.fireSkinLoaded(editor));
    } else {
      $_co2r8vuejjgw5pgq.fireSkinLoaded(editor)();
    }
    return {};
  };
  var $_flxb06ufjjgw5pgs = { render: render$1 };
  ...
  var $_9l6jt3v2jjgw5pju = { setup: setup };
  ...
  var renderUI = function (editor, theme, args) {
    ...
    $_9l6jt3v2jjgw5pju.setup(editor, theme);
    return isInline(editor) ? $_flxb06ufjjgw5pgs.render(editor, theme, args) : $_7b0uhjtvjjgw5pez.render(editor, theme, args);
  };
  var $_s1dkgtrjjgw5per = { renderUI: renderUI };

  var Tooltip = Control$1.extend({
    Mixins: [$_90yctbukjjgw5phk],
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_2emj7yu4jjgw5pfj.inheritUiContainer(this, this._tooltip);
  ...
  var Window$$1 = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self$$1._fullscreen) {
        ...
        if (!state) {
          self$$1.borderBox = $_7jd1byuqjjgw5pil.parseBox(self$$1.settings.border);
          ...
          self$$1.borderBox = $_7jd1byuqjjgw5pil.parseBox('0');
  ...
  var get = function (editor) {
    var renderUI = function (args) {
      return $_s1dkgtrjjgw5per.renderUI(editor, this, args);
    };
    var resizeTo = function (w, h) {
      return $_f42v9rubjjgw5pgk.resizeTo(editor, w, h);
    };
    var resizeBy = function (dw, dh) {
      return $_f42v9rubjjgw5pgk.resizeBy(editor, dw, dh);
    };
  ...
  var isComment = function (element) {
    return type(element) === $_9m8cm5w5jjgw5pnj.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_9m8cm5w5jjgw5pnj.ELEMENT);
  var isText = isType$1($_9m8cm5w5jjgw5pnj.TEXT);
  var isDocument = isType$1($_9m8cm5w5jjgw5pnj.DOCUMENT);
  var $_2w54ksw4jjgw5pni = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_2w54ksw4jjgw5pni.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_9h1t9qwcjjgw5poi = { toArray: toArray };
  ...
  var $_60syepwfjjgw5pp0 = { getOrDie: getOrDie };

  var node = function () {
    var f = $_60syepwfjjgw5pp0.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_dbce0wwljjgw5ppg.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_dbce0wwljjgw5ppg.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_dbce0wwljjgw5ppg.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_279d7uwpjjgw5ppu = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_279d7uwpjjgw5ppu.browsers();
    var oses = $_279d7uwpjjgw5ppu.oses();
    var browser = $_1qrc6gwojjgw5ppq.detectBrowser(browsers, userAgent).fold($_42n9mgwkjjgw5ppc.unknown, $_42n9mgwkjjgw5ppc.nu);
    var os = $_1qrc6gwojjgw5ppq.detectOs(oses, userAgent).fold($_ckv2ebwmjjgw5pph.unknown, $_ckv2ebwmjjgw5pph.nu);
  ...
  var $_cjvmblwjjjgw5ppb = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_cjvmblwjjjgw5ppb.detect(userAgent);
  });
  var $_3b9ybtwijjgw5pp6 = { detect: detect$3 };

  var ELEMENT = $_9m8cm5w5jjgw5pnj.ELEMENT;
  var DOCUMENT = $_9m8cm5w5jjgw5pnj.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_199a8xwejjgw5poz.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_3b9ybtwijjgw5pp6.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_luu4nwdjjgw5poj = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_dztqvvwtjjgw5pq9.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_luu4nwdjjgw5poj.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_luu4nwdjjgw5poj.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_9h1t9qwcjjgw5poi.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_9h1t9qwcjjgw5poi.toArray(element, nextSibling);
  };
  ...
  var all$1 = function (predicate) {
    return descendants($_4v1ipew2jjgw5pnd.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_fu1sq2w6jjgw5pnm.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_fu1sq2w6jjgw5pnm.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_fu1sq2w6jjgw5pnm.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each($_fu1sq2w6jjgw5pnm.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_dztqvvwtjjgw5pq9.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_7fnjnew1jjgw5pn9.ancestors(scope, function (e) {
      return $_dztqvvwtjjgw5pq9.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_7fnjnew1jjgw5pn9.siblings(scope, function (e) {
      return $_dztqvvwtjjgw5pq9.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_7fnjnew1jjgw5pn9.children(scope, function (e) {
      return $_dztqvvwtjjgw5pq9.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_dztqvvwtjjgw5pq9.all(selector, scope);
  };
  var $_2xws3uw0jjgw5pn8 = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return map($_2xws3uw0jjgw5pn8.descendants(Element$$1.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var $_bdhcrgvxjjgw5pml = { find: find$3 };
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_bdhcrgvxjjgw5pml.find(bodyElm);
  ...
  var first$1 = function (predicate) {
    return descendant($_4v1ipew2jjgw5pnd.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_luu4nwdjjgw5poj.eq(scope, x) && predicate(x);
    });
  };
  ...
  var first$2 = function (selector) {
    return $_dztqvvwtjjgw5pq9.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_6rrv1qwzjjgw5pr4.ancestor(scope, function (e) {
      return $_dztqvvwtjjgw5pq9.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_6rrv1qwzjjgw5pr4.sibling(scope, function (e) {
      return $_dztqvvwtjjgw5pq9.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_6rrv1qwzjjgw5pr4.child(scope, function (e) {
      return $_dztqvvwtjjgw5pq9.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_dztqvvwtjjgw5pq9.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_dztqvvwtjjgw5pq9.is, ancestor$1, scope, selector, isRoot);
  };
  var $_qexm5wyjjgw5pr3 = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
  ...
  var $_53bxx2x1jjgw5prm = { register: register };
  ...
  var $_2cmm9wx3jjgw5prq = { register: register$1 };
  ...
  var $_82m4nix4jjgw5prt = { register: register$2 };
  ...
  var $_byyehdx5jjgw5pry = { register: register$3 };
  ...
  var $_dv240vx6jjgw5ps2 = { register: register$4 };
  ...
  var $_8pwa91x7jjgw5ps5 = { register: register$5 };
  ...
  var $_g0c6xtx8jjgw5ps9 = { register: register$6 };
  ...
  var $_42a1p5x9jjgw5psb = { register: register$7 };
  ...
  var $_4pujcsxajjgw5psd = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$8.container = $_qexm5wyjjgw5pr3.descendant(Element$$1.fromDom(document.body), editor.settings.ui_container).fold(constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup$1 = function (editor) {
    ...
    setupEnvironment();
    $_dv240vx6jjgw5ps2.register(editor);
    $_53bxx2x1jjgw5prm.register(editor);
    $_g0c6xtx8jjgw5ps9.register(editor);
    $_42a1p5x9jjgw5psb.register(editor);
    $_82m4nix4jjgw5prt.register(editor);
    $_2cmm9wx3jjgw5prq.register(editor);
    $_byyehdx5jjgw5pry.register(editor);
    $_4pujcsxajjgw5psd.register(editor);
    $_8pwa91x7jjgw5ps5.register(editor);
  };
  var $_f71e8xwxjjgw5pqx = { setup: setup$1 };
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_fyz5aauxjjgw5pjc,
      Control: Control$1,
      Factory: global$4,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_6ciwm3uzjjgw5pjl,
      Panel: Panel,
      Movable: $_90yctbukjjgw5phk,
      Resizable: $_5kdnvgv1jjgw5pjs,
      ...
      FormatControls: $_f71e8xwxjjgw5pqx,
  ...
  global.add('modern', function (editor) {
    $_f71e8xwxjjgw5pqx.setup(editor);
    return $_gg1iktqjjgw5pep.get(editor);
  });
  function Theme () {
  }
