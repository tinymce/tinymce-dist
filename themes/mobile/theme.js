...
var mobile = (function () {
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_3tvl62y7jk26iman.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_3tvl62y7jk26iman.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_3tvl62y7jk26iman.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_dwmtaeycjk26imba = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_dwmtaeycjk26imba.browsers();
    var oses = $_dwmtaeycjk26imba.oses();
    var browser = $_3bmsl4yajk26imb1.detectBrowser(browsers, userAgent).fold($_fjlhvly6jk26imaj.unknown, $_fjlhvly6jk26imaj.nu);
    var os = $_3bmsl4yajk26imb1.detectOs(oses, userAgent).fold($_egj896y8jk26imar.unknown, $_egj896y8jk26imar.nu);
  ...
  var $_6e3u53y5jk26imah = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_6e3u53y5jk26imah.detect(userAgent);
  });
  var $_5mqjb5y3jk26imac = { detect: detect$3 };
  ...
  var tap = alloy.tap;
  var tapOrClick = $_5mqjb5y3jk26imac.detect().deviceType.isTouch() ? alloy.tap : click;
  ...
  var isComment = function (element) {
    return type(element) === $_9glk7eyljk26imd3.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_9glk7eyljk26imd3.ELEMENT);
  var isText = isType$1($_9glk7eyljk26imd3.TEXT);
  var isDocument = isType$1($_9glk7eyljk26imd3.DOCUMENT);
  var $_28nlgkykjk26imd2 = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_28nlgkykjk26imd2.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_2rxvlsysjk26imdu = { toArray: toArray };
  ...
  var $_5cbsiqyvjk26imea = { getOrDie: getOrDie };

  var node = function () {
    var f = $_5cbsiqyvjk26imea.getOrDie('Node');
    return f;
  };
  ...
  var $_2huqs8yujk26ime8 = {
    documentPositionPreceding: documentPositionPreceding,
    documentPositionContainedBy: documentPositionContainedBy
  };

  var ELEMENT = $_9glk7eyljk26imd3.ELEMENT;
  var DOCUMENT = $_9glk7eyljk26imd3.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_2huqs8yujk26ime8.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_5mqjb5y3jk26imac.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_a0tnmgytjk26imdw = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_7ctcwnyyjk26imef.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_a0tnmgytjk26imdw.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_a0tnmgytjk26imdw.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_2rxvlsysjk26imdu.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_2rxvlsysjk26imdu.toArray(element, nextSibling);
  };
  ...
  var before = function (marker, element) {
    var parent = $_1p1gyhynjk26imd8.parent(marker);
    parent.each(function (v) {
      v.dom().insertBefore(element.dom(), marker.dom());
    });
  };
  var after = function (marker, element) {
    var sibling = $_1p1gyhynjk26imd8.nextSibling(marker);
  ...
  var prepend = function (parent, element) {
    var firstChild = $_1p1gyhynjk26imd8.firstChild(parent);
  ...
  var appendAt = function (parent, element, index) {
    $_1p1gyhynjk26imd8.child(parent, index).fold(function () {
      append(parent, element);
    }, function (v) {
      before(v, element);
    });
  ...
  var before$1 = function (marker, elements) {
    each$1(elements, function (x) {
      $_7esu9pymjk26imd5.before(marker, x);
    });
  };
  var after$1 = function (marker, elements) {
    each$1(elements, function (x, i) {
      var e = i === 0 ? marker : elements[i - 1];
      $_7esu9pymjk26imd5.after(e, x);
    });
  };
  var prepend$1 = function (parent, elements) {
    each$1(elements.slice().reverse(), function (x) {
      $_7esu9pymjk26imd5.prepend(parent, x);
    });
  };
  var append$1 = function (parent, elements) {
    each$1(elements, function (x) {
      $_7esu9pymjk26imd5.append(parent, x);
    });
  };
  var $_c7jzlcz0jk26imeu = {
    before: before$1,
    after: after$1,
    prepend: prepend$1,
    append: append$1
  ...
  var empty = function (element) {
    ...
    each$1($_1p1gyhynjk26imd8.children(element), function (rogue) {
      remove(rogue);
    });
  };
  ...
  var unwrap = function (wrapper) {
    var children = $_1p1gyhynjk26imd8.children(wrapper);
    if (children.length > 0)
      $_c7jzlcz0jk26imeu.before(wrapper, children);
    remove(wrapper);
  };
  var $_7s0cxsyzjk26imen = {
    empty: empty,
    remove: remove,
    unwrap: unwrap
  };
  ...
  var attach = function (parent, child) {
    attachWith(parent, child, $_7esu9pymjk26imd5.append);
  };
  var attachWith = function (parent, child, insertion) {
    parent.getSystem().addToWorld(child);
    insertion(parent.element(), child.element());
    if ($_edbrc1yhjk26imc9.inBody(parent.element())) {
      fireAttaching(child);
    }
  ...
  var doDetach = function (component) {
    ...
    $_7s0cxsyzjk26imen.remove(component.element());
    component.getSystem().removeFromWorld(component);
  };
  var detach = function (component) {
    var parent = $_1p1gyhynjk26imd8.parent(component.element()).bind(function (p) {
  ...
  var detachChildren = function (component) {
    ...
    $_7s0cxsyzjk26imen.empty(component.element());
    component.syncComponents();
  };
  var attachSystem = function (element, guiSystem) {
    $_7esu9pymjk26imd5.append(element, guiSystem.element());
    var children = $_1p1gyhynjk26imd8.children(guiSystem.element());
  ...
  var json = function () {
    return $_5cbsiqyvjk26imea.getOrDie('JSON');
  };
  ...
  var $_bzno2azhjk26imie = {
    parse: parse,
    stringify: stringify
  };

  var formatObj = function (input) {
    return isObject(input) && keys(input).length > 100 ? ' removed due to size' : $_bzno2azhjk26imie.stringify(input, null, 2);
  };
  ...
  var isSource = function (component, simulatedEvent) {
    return $_a0tnmgytjk26imdw.eq(component.element(), simulatedEvent.event().target());
  };

  var nu$4 = function (parts) {
    if (!hasKey$1(parts, 'can') && !hasKey$1(parts, 'abort') && !hasKey$1(parts, 'run')) {
      throw new Error('EventHandler defined by: ' + $_bzno2azhjk26imie.stringify(parts, null, 2) + ' does not have can, abort, or run!');
    }
  ...
  var defToStr = function (defn) {
    ...
    return $_bzno2azhjk26imie.stringify(raw, null, 2);
  };
  var defToRaw = function (defn) {
    return {
      ...
      defChildren: defn.defChildren().fold(function () {
        ...
        return $_bzno2azhjk26imie.stringify(d, null, 2);
      }),
  ...
  var transfer = function (source, destination, attrs) {
    if (!$_28nlgkykjk26imd2.isElement(source) || !$_28nlgkykjk26imd2.isElement(destination))
      return;
    each$1(attrs, function (attr) {
      transferOne(source, destination, attr);
    });
  };
  var $_a03svjzwjk26immh = {
    clone: clone,
    set: set,
    setAll: setAll,
    get: get,
  ...
  var read$1 = function (element, attr) {
    var value = $_a03svjzwjk26immh.get(element, attr);
    return value === undefined || value === '' ? [] : value.split(' ');
  };
  var add = function (element, attr, id) {
    var old = read$1(element, attr);
    var nu = old.concat([id]);
    $_a03svjzwjk26immh.set(element, attr, nu.join(' '));
    return true;
  };
  var remove$2 = function (element, attr, id) {
    ...
    if (nu.length > 0)
      ...
      $_a03svjzwjk26immh.remove(element, attr);
    return false;
  };
  var $_7ilruozyjk26immx = {
    read: read$1,
    add: add,
    remove: remove$2
  };
  ...
  var get$1 = function (element) {
    return $_7ilruozyjk26immx.read(element, 'class');
  };
  var add$1 = function (element, clazz) {
    return $_7ilruozyjk26immx.add(element, 'class', clazz);
  };
  var remove$3 = function (element, clazz) {
    return $_7ilruozyjk26immx.remove(element, 'class', clazz);
  };
  ...
  var add$2 = function (element, clazz) {
    if ($_651504zxjk26immt.supports(element))
      element.dom().classList.add(clazz);
    else
      $_651504zxjk26immt.add(element, clazz);
  };
  var cleanClass = function (element) {
    var classList = $_651504zxjk26immt.supports(element) ? element.dom().classList : $_651504zxjk26immt.get(element);
    if (classList.length === 0) {
      $_a03svjzwjk26immh.remove(element, 'class');
    }
  };
  var remove$4 = function (element, clazz) {
    if ($_651504zxjk26immt.supports(element)) {
      ...
      $_651504zxjk26immt.remove(element, clazz);
    cleanClass(element);
  };
  var toggle$1 = function (element, clazz) {
    return $_651504zxjk26immt.supports(element) ? element.dom().classList.toggle(clazz) : $_651504zxjk26immt.toggle(element, clazz);
  };
  var toggler = function (element, clazz) {
    var hasClasslist = $_651504zxjk26immt.supports(element);
    var classList = element.dom().classList;
    var off = function () {
      if (hasClasslist)
        classList.remove(clazz);
  ...
  var has$1 = function (element, clazz) {
    return $_651504zxjk26immt.supports(element) && element.dom().classList.contains(clazz);
  };
  var $_6f40k8zujk26immd = {
    add: add$2,
    remove: remove$4,
    toggle: toggle$1,
    toggler: toggler,
  ...
  var swap = function (element, addCls, removeCls) {
    $_6f40k8zujk26immd.remove(element, removeCls);
    $_6f40k8zujk26immd.add(element, addCls);
  };
  ...
  var clear = function (component, swapConfig, swapState) {
    $_6f40k8zujk26immd.remove(component.element(), swapConfig.alpha());
    $_6f40k8zujk26immd.remove(component.element(), swapConfig.omega());
  };
  var isAlpha = function (component, swapConfig, swapState) {
    return $_6f40k8zujk26immd.has(component.element(), swapConfig.alpha());
  };
  var isOmega = function (component, swapConfig, swapState) {
    return $_6f40k8zujk26immd.has(component.element(), swapConfig.omega());
  };
  ...
  var first$1 = function (predicate) {
    return descendant($_edbrc1yhjk26imc9.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_a0tnmgytjk26imdw.eq(scope, x) && predicate(x);
    });
  };
  ...
  var any$1 = function (predicate) {
    return $_c54u12103jk26imng.first(predicate).isSome();
  };
  var ancestor$1 = function (scope, predicate, isRoot) {
    return $_c54u12103jk26imng.ancestor(scope, predicate, isRoot).isSome();
  };
  var closest$1 = function (scope, predicate, isRoot) {
    return $_c54u12103jk26imng.closest(scope, predicate, isRoot).isSome();
  };
  var sibling$1 = function (scope, predicate) {
    return $_c54u12103jk26imng.sibling(scope, predicate).isSome();
  };
  var child$2 = function (scope, predicate) {
    return $_c54u12103jk26imng.child(scope, predicate).isSome();
  };
  var descendant$1 = function (scope, predicate) {
    return $_c54u12103jk26imng.descendant(scope, predicate).isSome();
  };
  var $_9lby7e102jk26imne = {
    any: any$1,
    ancestor: ancestor$1,
    closest: closest$1,
    sibling: sibling$1,
  ...
  var hasFocus = function (element) {
    var doc = $_1p1gyhynjk26imd8.owner(element).dom();
  ...
  var focusInside = function (element) {
    var doc = $_1p1gyhynjk26imd8.owner(element);
    var inside = active(doc).filter(function (a) {
      return $_9lby7e102jk26imne.closest(a, curry($_a0tnmgytjk26imdw.eq, element));
    });
  ...
  var search = function (element) {
    return active($_1p1gyhynjk26imd8.owner(element)).filter(function (e) {
      return element.dom().contains(e.dom());
    });
  };
  var $_1pdvem101jk26imn6 = {
    hasFocus: hasFocus,
    focus: focus$2,
    blur: blur$$1,
    active: active,
  ...
  var $_53s8lv107jk26imo3 = { openLink: openLink };
  ...
  var fromHtml$1 = function (html, scope) {
    ...
    var div = doc.createElement('div');
    div.innerHTML = html;
    return $_1p1gyhynjk26imd8.children(Element$$1.fromDom(div));
  };
  ...
  var set$1 = function (element, content) {
    var owner = $_1p1gyhynjk26imd8.owner(element);
    var docDom = owner.dom();
    var fragment = Element$$1.fromDom(docDom.createDocumentFragment());
    var contentElements = $_2tgb2f10gjk26impj.fromHtml(content, docDom);
    $_c7jzlcz0jk26imeu.append(fragment, contentElements);
    $_7s0cxsyzjk26imen.empty(element);
    $_7esu9pymjk26imd5.append(element, fragment);
  };
  var getOuter = function (element) {
    var container = Element$$1.fromTag('div');
    var clone = Element$$1.fromDom(element.dom().cloneNode(true));
    $_7esu9pymjk26imd5.append(container, clone);
    return get$2(container);
  };
  var $_67epqi10fjk26impi = {
    get: get$2,
    set: set$1,
    getOuter: getOuter
  };
  ...
  var shallowAs = function (original, tag) {
    ...
    var attributes = $_a03svjzwjk26immh.clone(original);
    $_a03svjzwjk26immh.setAll(nu, attributes);
    return nu;
  };
  var copy = function (original, tag) {
    var nu = shallowAs(original, tag);
    var cloneChildren = $_1p1gyhynjk26imd8.children(deep$1(original));
    $_c7jzlcz0jk26imeu.append(nu, cloneChildren);
    return nu;
  };
  var mutate = function (original, tag) {
    var nu = shallowAs(original, tag);
    $_7esu9pymjk26imd5.before(original, nu);
    var children = $_1p1gyhynjk26imd8.children(original);
    $_c7jzlcz0jk26imeu.append(nu, children);
    $_7s0cxsyzjk26imen.remove(original);
    return nu;
  };
  var $_8u2iug10hjk26impo = {
    shallow: shallow$1,
    shallowAs: shallowAs,
    deep: deep$1,
    copy: copy,
  ...
  var getHtml = function (element) {
    var clone = $_8u2iug10hjk26impo.shallow(element);
    return $_67epqi10fjk26impi.getOuter(clone);
  };
  ...
  var toggle$2 = function (component, toggleConfig, toggleState) {
    $_6f40k8zujk26immd.toggle(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var on = function (component, toggleConfig, toggleState) {
    $_6f40k8zujk26immd.add(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var off = function (component, toggleConfig, toggleState) {
    $_6f40k8zujk26immd.remove(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var isOn = function (component, toggleConfig) {
    return $_6f40k8zujk26immd.has(component.element(), toggleConfig.toggleClass());
  };
  ...
  var updatePressed = function (component, ariaInfo, status) {
    $_a03svjzwjk26immh.set(component.element(), 'aria-pressed', status);
    if (ariaInfo.syncWithExpanded()) {
      updateExpanded(component, ariaInfo, status);
    }
  };
  var updateSelected = function (component, ariaInfo, status) {
    $_a03svjzwjk26immh.set(component.element(), 'aria-selected', status);
  };
  var updateChecked = function (component, ariaInfo, status) {
    $_a03svjzwjk26immh.set(component.element(), 'aria-checked', status);
  };
  var updateExpanded = function (component, ariaInfo, status) {
    $_a03svjzwjk26immh.set(component.element(), 'aria-expanded', status);
  };
  ...
  var format = function (command, update) {
    return Receiving.config({
      channels: wrap$2($_7t51r1109jk26imo8.formatChanged(), {
  ...
  var orientation = function (onReceive) {
    return Receiving.config({ channels: wrap$2($_7t51r1109jk26imo8.orientationChanged(), { onReceive: onReceive }) });
  };
  ...
  var events$2 = function (optAction) {
    ...
    var pointerEvents = $_5mqjb5y3jk26imac.detect().deviceType.isTouch() ? [run(tap(), onClick)] : [
      run(click(), onClick),
  ...
  var focus$3 = function (component, focusConfig) {
    if (!focusConfig.ignore()) {
      $_1pdvem101jk26imn6.focus(component.element());
      focusConfig.onFocus()(component);
    }
  };
  var blur$1 = function (component, focusConfig) {
    if (!focusConfig.ignore()) {
      $_1pdvem101jk26imn6.blur(component.element());
    }
  };
  var isFocused = function (component) {
    return $_1pdvem101jk26imn6.hasFocus(component.element());
  };
  ...
  var $_e1fa3q117jk26imvr = { isSupported: isSupported };
  ...
  var internalSet = function (dom, property, value) {
    ...
    if ($_e1fa3q117jk26imvr.isSupported(dom))
  ...
  var get$3 = function (element, property) {
    ...
    var v = r === '' && !$_edbrc1yhjk26imc9.inBody(element) ? getUnsafeProperty(dom, property) : r;
    return v === null ? undefined : v;
  };
  var getUnsafeProperty = function (dom, property) {
    return $_e1fa3q117jk26imvr.isSupported(dom) ? dom.style.getPropertyValue(property) : '';
  };
  ...
  var remove$5 = function (element, property) {
    ...
    if ($_a03svjzwjk26immh.has(element, 'style') && trim($_a03svjzwjk26immh.get(element, 'style')) === '') {
      $_a03svjzwjk26immh.remove(element, 'style');
    }
  };
  var preserve = function (element, f) {
    var oldStyles = $_a03svjzwjk26immh.get(element, 'style');
    var result = f(element);
    var restore = oldStyles === undefined ? $_a03svjzwjk26immh.remove : $_a03svjzwjk26immh.set;
  ...
  var copy$1 = function (source, target) {
    ...
    if ($_e1fa3q117jk26imvr.isSupported(sourceDom) && $_e1fa3q117jk26imvr.isSupported(targetDom)) {
  ...
  function Dimension (name, getOffset) {
    ...
    var get = function (element) {
      ...
      if (r <= 0 || r === null) {
        var css = $_34bxt1116jk26imva.get(element, name);
    ...
    var aggregate = function (element, properties) {
      return foldl(properties, function (acc, property) {
        var val = $_34bxt1116jk26imva.get(element, property);
  ...
  var api = Dimension('height', function (element) {
    var dom = element.dom();
    return $_edbrc1yhjk26imc9.inBody(element) ? dom.getBoundingClientRect().height : dom.offsetHeight;
  });
  ...
  var setMax = function (element, value) {
    ...
    $_34bxt1116jk26imva.set(element, 'max-height', absMax + 'px');
  };
  var $_c1p1ek115jk26imv8 = {
    set: set$3,
    get: get$4,
    getOuter: getOuter$1,
    setMax: setMax
  ...
  var all$2 = function (predicate) {
    return descendants($_edbrc1yhjk26imc9.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_1p1gyhynjk26imd8.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_1p1gyhynjk26imd8.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_1p1gyhynjk26imd8.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each$1($_1p1gyhynjk26imd8.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$3 = function (selector) {
    return $_7ctcwnyyjk26imef.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_7ifv5s11ajk26imw1.ancestors(scope, function (e) {
      return $_7ctcwnyyjk26imef.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_7ifv5s11ajk26imw1.siblings(scope, function (e) {
      return $_7ctcwnyyjk26imef.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_7ifv5s11ajk26imw1.children(scope, function (e) {
      return $_7ctcwnyyjk26imef.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_7ctcwnyyjk26imef.all(selector, scope);
  };
  var $_1roeab119jk26imw0 = {
    all: all$3,
  ...
  var first$2 = function (selector) {
    return $_7ctcwnyyjk26imef.one(selector);
  };
  var ancestor$2 = function (scope, selector, isRoot) {
    return $_c54u12103jk26imng.ancestor(scope, function (e) {
      return $_7ctcwnyyjk26imef.is(e, selector);
    }, isRoot);
  };
  var sibling$2 = function (scope, selector) {
    return $_c54u12103jk26imng.sibling(scope, function (e) {
      return $_7ctcwnyyjk26imef.is(e, selector);
    });
  };
  var child$3 = function (scope, selector) {
    return $_c54u12103jk26imng.child(scope, function (e) {
      return $_7ctcwnyyjk26imef.is(e, selector);
    });
  };
  var descendant$2 = function (scope, selector) {
    return $_7ctcwnyyjk26imef.one(selector, scope);
  };
  var closest$2 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_7ctcwnyyjk26imef.is, ancestor$2, scope, selector, isRoot);
  };
  var $_3ecwyw11bjk26imw8 = {
    first: first$2,
    ancestor: ancestor$2,
    sibling: sibling$2,
    child: child$3,
  ...
  var dehighlightAll = function (component, hConfig, hState) {
    var highlighted = $_1roeab119jk26imw0.descendants(component.element(), '.' + hConfig.highlightClass());
    each$1(highlighted, function (h) {
      $_6f40k8zujk26immd.remove(h, hConfig.highlightClass());
  ...
  var dehighlight = function (component, hConfig, hState, target) {
    ...
    $_6f40k8zujk26immd.remove(target.element(), hConfig.highlightClass());
    if (wasHighlighted) {
      hConfig.onDehighlight()(component, target);
    }
  };
  var highlight = function (component, hConfig, hState, target) {
    ...
    $_6f40k8zujk26immd.add(target.element(), hConfig.highlightClass());
    if (!wasHighlighted) {
  ...
  var highlightBy = function (component, hConfig, hState, predicate) {
    var items = $_1roeab119jk26imw0.descendants(component.element(), '.' + hConfig.itemClass());
  ...
  var isHighlighted = function (component, hConfig, hState, queryTarget) {
    return $_6f40k8zujk26immd.has(queryTarget.element(), hConfig.highlightClass());
  };
  var getHighlighted = function (component, hConfig, hState) {
    return $_3ecwyw11bjk26imw8.descendant(component.element(), '.' + hConfig.highlightClass()).bind(function (e) {
  ...
  var getFirst = function (component, hConfig, hState) {
    return $_3ecwyw11bjk26imw8.descendant(component.element(), '.' + hConfig.itemClass()).bind(function (e) {
      return component.getSystem().getByDom(e).toOption();
    });
  };
  ...
  var getDelta = function (component, hConfig, hState, delta) {
    ...
    var current = findIndex(items, function (item) {
      return $_6f40k8zujk26immd.has(item, hConfig.highlightClass());
    });
  ...
  var dom = function () {
    var get = function (component) {
      return $_1pdvem101jk26imn6.search(component.element());
    };
  ...
  var create$2 = function (cyclicField) {
    ...
    var isVisible = function (tabbingConfig, element) {
      var target = tabbingConfig.visibilitySelector().bind(function (sel) {
        return $_3ecwyw11bjk26imw8.closest(element, sel);
      }).getOr(element);
      return $_c1p1ek115jk26imv8.get(target) > 0;
    };
    var findInitial = function (component, tabbingConfig) {
      var tabstops = $_1roeab119jk26imw0.descendants(component.element(), tabbingConfig.selector());
    ...
    var findCurrent = function (component, tabbingConfig) {
      return tabbingConfig.focusManager().get(component).bind(function (elem) {
        return $_3ecwyw11bjk26imw8.closest(elem, tabbingConfig.selector());
      });
    };
    ...
    var go = function (component, simulatedEvent, tabbingConfig, cycle) {
      ...
      return findCurrent(component, tabbingConfig).bind(function (tabstop) {
        var optStopIndex = findIndex(tabstops, curry($_a0tnmgytjk26imdw.eq, tabstop));
  ...
  var inside = function (target) {
    return $_28nlgkykjk26imd2.name(target) === 'input' && $_a03svjzwjk26immh.get(target, 'type') !== 'radio' || $_28nlgkykjk26imd2.name(target) === 'textarea';
  };
  ...
  var getDirection = function (element) {
    return $_34bxt1116jk26imva.get(element, 'direction') === 'rtl' ? 'rtl' : 'ltr';
  };
  var $_9fr8az11tjk26imzr = {
  ...
  var west = function (moveLeft, moveRight) {
    var movement = $_9fr8az11tjk26imzr.onDirection(moveLeft, moveRight);
    return useH(movement);
  };
  var east = function (moveLeft, moveRight) {
    var movement = $_9fr8az11tjk26imzr.onDirection(moveRight, moveLeft);
    return useH(movement);
  };
  ...
  var visibilityToggler = function (element, property, hiddenValue, visibleValue) {
    var initial = $_34bxt1116jk26imva.get(element, property);
    if (initial === undefined)
      initial = '';
    var value = initial === hiddenValue ? visibleValue : hiddenValue;
    var off = curry($_34bxt1116jk26imva.set, element, property, initial);
    var on = curry($_34bxt1116jk26imva.set, element, property, value);
  ...
  var locateVisible = function (container, current, selector) {
    var filter$$1 = $_3dy1ki11vjk26in08.isVisible;
    return locateIn(container, current, selector, filter$$1);
  };
  var locateIn = function (container, current, selector, filter$$1) {
    var predicate = curry($_a0tnmgytjk26imdw.eq, current);
    var candidates = $_1roeab119jk26imw0.descendants(container, selector);
    var visible = filter(candidates, $_3dy1ki11vjk26in08.isVisible);
    return locate(visible, predicate);
  };
  var findIndex$2 = function (elements, target) {
    return findIndex(elements, function (elem) {
      return $_a0tnmgytjk26imdw.eq(target, elem);
    });
  };
  ...
  var focusIn = function (component, gridConfig, gridState) {
    $_3ecwyw11bjk26imw8.descendant(component.element(), gridConfig.selector()).each(function (first) {
      gridConfig.focusManager().set(component, first);
    });
  };
  var findCurrent = function (component, gridConfig) {
    return gridConfig.focusManager().get(component).bind(function (elem) {
      return $_3ecwyw11bjk26imw8.closest(elem, gridConfig.selector());
    });
  };
  ...
  var findCurrent$1 = function (component, flowConfig) {
    return flowConfig.focusManager().get(component).bind(function (elem) {
      return $_3ecwyw11bjk26imw8.closest(elem, flowConfig.selector());
    });
  };
  ...
  var focusIn$1 = function (component, flowConfig) {
    flowConfig.getInitial()(component).or($_3ecwyw11bjk26imw8.descendant(component.element(), flowConfig.selector())).each(function (first) {
  ...
  var focusIn$2 = function (component, matrixConfig) {
    var focused = matrixConfig.previousSelector()(component).orThunk(function () {
      ...
      return $_3ecwyw11bjk26imw8.descendant(component.element(), selectors.cell());
    });
  ...
  var execute$4 = function (component, simulatedEvent, matrixConfig) {
    return $_1pdvem101jk26imn6.search(component.element()).bind(function (focused) {
      return matrixConfig.execute()(component, simulatedEvent, focused);
    });
  };
  var toMatrix = function (rows, matrixConfig) {
    return map$1(rows, function (row) {
      return $_1roeab119jk26imw0.descendants(row, matrixConfig.selectors().cell());
    });
  };
  var doMove$2 = function (ifCycle, ifMove) {
    return function (element, focused, matrixConfig) {
      var move$$1 = matrixConfig.cycles() ? ifCycle : ifMove;
      return $_3ecwyw11bjk26imw8.closest(focused, matrixConfig.selectors().row()).bind(function (inRow) {
        var cellsInRow = $_1roeab119jk26imw0.descendants(inRow, matrixConfig.selectors().cell());
        return findIndex$2(cellsInRow, focused).bind(function (colIndex) {
          var allRows = $_1roeab119jk26imw0.descendants(element, matrixConfig.selectors().row());
  ...
  var focusIn$3 = function (component, menuConfig) {
    $_3ecwyw11bjk26imw8.descendant(component.element(), menuConfig.selector()).each(function (first) {
  ...
  var subPlaceholder = function (owner, detail, compSpec, placeholders) {
    ...
    return readOptFrom$1(placeholders, compSpec.name).fold(function () {
      throw new Error('Unknown placeholder component: ' + compSpec.name + '\nKnown: [' + keys(placeholders) + ']\nNamespace: ' + owner.getOr('none') + '\nSpec: ' + $_bzno2azhjk26imie.stringify(compSpec, null, 2));
    }, function (newSpec) {
  ...
  var substitutePlaces = function (owner, detail, components, placeholders) {
    ...
    each(ps, function (p) {
      if (p.used() === false && p.required()) {
        throw new Error('Placeholder: ' + p.name() + ' was not found in components list\nNamespace: ' + owner.getOr('none') + '\nComponents: ' + $_bzno2azhjk26imie.stringify(detail.components(), null, 2));
      }
    });
    return outcome;
  };
  ...
  var write = function (label, elem) {
    ...
    $_a03svjzwjk26immh.set(elem, idAttr$1, id);
    return id;
  };
  var writeOnly = function (elem, uid) {
    $_a03svjzwjk26immh.set(elem, idAttr$1, uid);
  };
  var read$2 = function (elem) {
    var id = $_28nlgkykjk26imd2.isElement(elem) ? $_a03svjzwjk26immh.get(elem, idAttr$1) : null;
  ...
  var fromHtml$2 = function (html) {
    ...
    var children = $_1p1gyhynjk26imd8.children(elem);
    var attrs = getAttrs(elem);
    var classes = getClasses(elem);
    var contents = children.length === 0 ? {} : { innerHtml: $_67epqi10fjk26impi.get(elem) };
    return deepMerge({
      tag: $_28nlgkykjk26imd2.name(elem),
      classes: classes,
      attributes: attrs
    }, contents);
  };
  ...
  var dom$1 = function (rawHtml) {
    var html = supplant(rawHtml, { prefix: $_b7z5dh10tjk26imst.prefix() });
  ...
  var getToggleBehaviours = function (command) {
    return derive$2([
      Toggling.config({
        toggleClass: $_b7z5dh10tjk26imst.resolve('toolbar-button-selected'),
        toggleOnExecute: false,
        aria: { mode: 'pressed' }
      }),
      $_ashibi10sjk26imso.format(command, function (button, status) {
  ...
  var isTouch = $_5mqjb5y3jk26imac.detect().deviceType.isTouch();
  ...
  var platform = $_5mqjb5y3jk26imac.detect();
  ...
  var isTouch$2 = $_5mqjb5y3jk26imac.detect().deviceType.isTouch();
  var SliderSchema = [
    strict$1('min'),
    strict$1('max'),
  ...
  var setMax$1 = function (element, value) {
    ...
    $_34bxt1116jk26imva.set(element, 'max-width', absMax + 'px');
  };
  var $_1yqkk6130jk26incg = {
    set: set$4,
    get: get$6,
    getOuter: getOuter$2,
    setMax: setMax$1
  ...
  var isTouch$3 = $_5mqjb5y3jk26imac.detect().deviceType.isTouch();
  var sketch$1 = function (detail, components$$1, spec, externals) {
    ...
    var refresh = function (component) {
      ...
      var thumbRadius = $_1yqkk6130jk26incg.get(thumb.element()) / 2;
      $_34bxt1116jk26imva.set(thumb.element(), 'left', pos - thumbRadius + 'px');
    };
    var changeValue = function (component, newValue) {
      var oldValue = detail.value().get();
      var thumb = getThumb(component);
      if (oldValue !== newValue || $_34bxt1116jk26imva.getRaw(thumb.element(), 'left').isNone()) {
  ...
  var button = function (realm, clazz, makeItems) {
    return $_eugz1f10ujk26imsw.forToolbar(clazz, function () {
      var items = makeItems();
  ...
  var makeSlider = function (spec$$1) {
    ...
    var onInit = function (slider, thumb, value) {
      ...
      $_34bxt1116jk26imva.set(thumb.element(), 'background-color', color);
    };
    ...
    return Slider.sketch({
      ...
      components: [
        ...
        Slider.parts().spectrum({
          ...
          behaviours: derive$2([Toggling.config({ toggleClass: $_b7z5dh10tjk26imst.resolve('thumb-active') })])
        }),
      ...
      sliderBehaviours: derive$2([$_ashibi10sjk26imso.orientation(Slider.refresh)])
    });
  };
  ...
  var sketch$3 = function (rawSpec) {
    ...
    return Slider.sketch({
      dom: {
        tag: 'div',
        classes: [
          $_b7z5dh10tjk26imst.resolve('slider-' + spec$$1.category + '-size-container'),
          $_b7z5dh10tjk26imst.resolve('slider'),
          $_b7z5dh10tjk26imst.resolve('slider-size-container')
        ]
      },
      onChange: onChange,
      onDragStart: function (slider, thumb) {
  ...
  var $_9jygyv133jk26incn = { sketch: sketch$3 };
  ...
  var getRawOrComputed = function (isRoot, rawStart) {
    var optStart = $_28nlgkykjk26imd2.isElement(rawStart) ? Option.some(rawStart) : $_1p1gyhynjk26imd8.parent(rawStart);
    return optStart.map(function (start) {
      var inline = $_c54u12103jk26imng.closest(start, function (elem) {
        return $_34bxt1116jk26imva.getRaw(elem, 'font-size').isSome();
      }, isRoot).bind(function (elem) {
        return $_34bxt1116jk26imva.getRaw(elem, 'font-size');
      });
      return inline.getOrThunk(function () {
        return $_34bxt1116jk26imva.get(start, 'font-size');
      });
    }).getOr('');
  };
  var getSize = function (editor) {
    ...
    var isRoot = function (e) {
      return $_a0tnmgytjk26imdw.eq(root, e);
    };
  ...
  var $_4ginwv134jk26incz = {
    candidates: constant(candidates),
    get: get$7,
    apply: apply$1
  };

  var sizes = $_4ginwv134jk26incz.candidates();
  var makeSlider$1 = function (spec$$1) {
    return $_9jygyv133jk26incn.sketch({
  ...
  var sketch$4 = function (realm, editor) {
    var spec$$1 = {
      onChange: function (value) {
        $_4ginwv134jk26incz.apply(editor, value);
      },
      getInitialValue: function () {
        return $_4ginwv134jk26incz.get(editor);
      }
    };
  ...
  function Blob (parts, properties) {
    var f = $_5cbsiqyvjk26imea.getOrDie('Blob');
    return new f(parts, properties);
  }

  function FileReader () {
    var f = $_5cbsiqyvjk26imea.getOrDie('FileReader');
    return new f();
  }

  function Uint8Array (arr) {
    var f = $_5cbsiqyvjk26imea.getOrDie('Uint8Array');
    return new f(arr);
  }

  var requestAnimationFrame = function (callback) {
    var f = $_5cbsiqyvjk26imea.getOrDie('requestAnimationFrame');
    f(callback);
  };
  var atob = function (base64) {
    var f = $_5cbsiqyvjk26imea.getOrDie('atob');
    return f(base64);
  };
  var $_at6rcm13fjk26inf7 = {
    atob: atob,
  ...
  function dataUriToBlobSync(uri) {
    ...
    var base64 = data[1];
    var sliceSize = 1024;
    var byteCharacters = $_at6rcm13fjk26inf7.atob(base64);
  ...
  function blobToCanvas(blob) {
    return blobToImage(blob).then(function (image) {
      ...
      var context, canvas;
      canvas = $_41xprn139jk26iney.create($_510hde13ajk26inez.getWidth(image), $_510hde13ajk26inez.getHeight(image));
      context = $_41xprn139jk26iney.get2dContext(canvas);
  ...
  var blobToImage$1 = function (image) {
    return $_bbyast138jk26ineh.blobToImage(image);
  };
  var imageToBlob$1 = function (blob) {
    return $_bbyast138jk26ineh.imageToBlob(blob);
  };
  var blobToDataUri$1 = function (blob) {
    return $_bbyast138jk26ineh.blobToDataUri(blob);
  };
  var blobToBase64$1 = function (blob) {
    return $_bbyast138jk26ineh.blobToBase64(blob);
  };
  var dataUriToBlobSync$1 = function (uri) {
    return $_bbyast138jk26ineh.dataUriToBlobSync(uri);
  };
  var uriToBlob$1 = function (uri) {
    return Option.from($_bbyast138jk26ineh.uriToBlob(uri));
  };
  var $_frrgsl137jk26inec = {
  ...
  var addImage = function (editor, blob) {
    $_frrgsl137jk26inec.blobToBase64(blob).then(function (base64) {
      editor.undoManager.transact(function () {
  ...
  var fromLink = function (link) {
    var text = $_chiurz13ijk26ing0.get(link);
    var url = $_a03svjzwjk26immh.get(link, 'href');
    var title = $_a03svjzwjk26immh.get(link, 'title');
    var target = $_a03svjzwjk26immh.get(link, 'target');
    return {
  ...
  var wasSimple = function (link) {
    var prevHref = $_a03svjzwjk26immh.get(link, 'href');
    var prevText = $_chiurz13ijk26ing0.get(link);
  ...
  var applyInfo = function (editor, info) {
    info.url.filter(isNotEmpty).fold(function () {
      ...
      activeLink.fold(function () {
        ...
        $_a03svjzwjk26immh.setAll(link, attrs);
        text.each(function (newText) {
          $_chiurz13ijk26ing0.set(link, newText);
        });
      });
    });
  };
  var query = function (editor) {
    ...
    return $_3ecwyw11bjk26imw8.closest(start, 'a');
  };
  var $_g8b1wa13hjk26infi = {
    getInfo: getInfo,
    applyInfo: applyInfo,
    query: query
  };

  var platform$1 = $_5mqjb5y3jk26imac.detect();
  ...
  var $_dx3ijc13jjk26ing0 = { forAndroid: forAndroid };
  ...
  var focusBehaviours = function (detail) {
    return derive$2([Focusing.config({
        onFocus: detail.selectOnFocus() === false ? noop : function (component) {
          ...
          var value = $_5iwx013tjk26inik.get(input);
    ...
    return deepMerge(derive$2([Representing.config({
        store: {
          ...
          getValue: function (input) {
            return $_5iwx013tjk26inik.get(input.element());
          },
          setValue: function (input, data) {
            var current = $_5iwx013tjk26inik.get(input.element());
            if (current !== data) {
              $_5iwx013tjk26inik.set(input.element(), data);
            }
          }
        },
    ...
    return {
      ...
      spec: Container.sketch({
        ...
        containerBehaviours: derive$2([
          Toggling.config({ toggleClass: $_b7z5dh10tjk26imst.resolve('input-container-empty') }),
          Composing.config({
            find: function (comp) {
  ...
  var hasNative = function (component) {
    return contains(nativeDisabled, $_28nlgkykjk26imd2.name(component.element()));
  };
  var nativeIsDisabled = function (component) {
    return $_a03svjzwjk26immh.has(component.element(), 'disabled');
  };
  var nativeDisable = function (component) {
    $_a03svjzwjk26immh.set(component.element(), 'disabled', 'disabled');
  };
  var nativeEnable = function (component) {
    $_a03svjzwjk26immh.remove(component.element(), 'disabled');
  };
  var ariaIsDisabled = function (component) {
    return $_a03svjzwjk26immh.get(component.element(), 'aria-disabled') === 'true';
  };
  var ariaDisable = function (component) {
    $_a03svjzwjk26immh.set(component.element(), 'aria-disabled', 'true');
  };
  var ariaEnable = function (component) {
    $_a03svjzwjk26immh.set(component.element(), 'aria-disabled', 'false');
  };
  var disable = function (component, disableConfig, disableState) {
    disableConfig.disableClass().each(function (disableClass) {
      $_6f40k8zujk26immd.add(component.element(), disableClass);
    });
  ...
  var enable = function (component, disableConfig, disableState) {
    disableConfig.disableClass().each(function (disableClass) {
      $_6f40k8zujk26immd.remove(component.element(), disableClass);
    });
  ...
  var sketch$7 = function (rawSpec) {
    ...
    var navigationButton = function (direction, directionName, enabled) {
      return Button.sketch({
        ...
        buttonBehaviours: derive$2([Disabling.config({
            disableClass: $_b7z5dh10tjk26imst.resolve('toolbar-navigation-disabled'),
            disabled: !enabled
          })])
      });
    };
    var reposition = function (dialog, message) {
      $_3ecwyw11bjk26imw8.descendant(dialog.element(), '.' + $_b7z5dh10tjk26imst.resolve('serialised-dialog-chain')).each(function (parent) {
        $_34bxt1116jk26imva.set(parent, 'left', -spec$$1.state.currentScreen.get() * message.width + 'px');
      });
    };
    var navigate = function (dialog, direction) {
      var screens = $_1roeab119jk26imw0.descendants(dialog.element(), '.' + $_b7z5dh10tjk26imst.resolve('serialised-dialog-screen'));
      $_3ecwyw11bjk26imw8.descendant(dialog.element(), '.' + $_b7z5dh10tjk26imst.resolve('serialised-dialog-chain')).each(function (parent) {
        if (spec$$1.state.currentScreen.get() + direction >= 0 && spec$$1.state.currentScreen.get() + direction < screens.length) {
          $_34bxt1116jk26imva.getRaw(parent, 'left').each(function (left) {
            var currentLeft = parseInt(left, 10);
            var w = $_1yqkk6130jk26incg.get(screens[0]);
            $_34bxt1116jk26imva.set(parent, 'left', currentLeft - direction * w + 'px');
          });
    ...
    var focusInput = function (dialog) {
      var inputs = $_1roeab119jk26imw0.descendants(dialog.element(), 'input');
    ...
    var memForm = record(Form.sketch(function (parts) {
      return {
        ...
        formBehaviours: derive$2([
          $_ashibi10sjk26imso.orientation(function (dialog, message) {
    ...
    var memDots = record({
      ...
      behaviours: derive$2([Highlighting.config({
          highlightClass: $_b7z5dh10tjk26imst.resolve('dot-active'),
          itemClass: $_b7z5dh10tjk26imst.resolve('dot-item')
        })]),
      ...
      behaviours: derive$2([
        ...
        config(wrapperAdhocEvents, [
          run(touchstart(), function (wrapper, simulatedEvent) {
            var event = simulatedEvent.event();
            spec$$1.state.dialogSwipeState.set($_56t28v144jk26inle.init(event.touches[0].clientX));
          }),
          run(touchmove(), function (wrapper, simulatedEvent) {
            var event = simulatedEvent.event();
            spec$$1.state.dialogSwipeState.on(function (state) {
              simulatedEvent.event().prevent();
              spec$$1.state.dialogSwipeState.set($_56t28v144jk26inle.move(state, event.raw().touches[0].clientX));
            });
          }),
          run(touchend(), function (wrapper) {
            spec$$1.state.dialogSwipeState.on(function (state) {
              var dialog = memForm.get(wrapper);
              var direction = -1 * $_56t28v144jk26inle.complete(state);
              navigate(dialog, direction);
            });
          })
        ])
  ...
  var getGroups = cached(function (realm, editor) {
    return [{
        ...
        items: [sketch$7({
            ...
            getInitialValue: function () {
              return Option.some($_g8b1wa13hjk26infi.getInfo(editor));
            },
            onExecute: function (dialog) {
              var info = Representing.getValue(dialog);
              $_g8b1wa13hjk26infi.applyInfo(editor, info);
  ...
  var sketch$8 = function (realm, editor) {
    return $_eugz1f10ujk26imsw.forToolbarStateAction(editor, 'link', 'link', function () {
      var groups = getGroups(realm, editor);
      realm.setContextToolbar(groups);
      $_dx3ijc13jjk26ing0.forAndroid(editor, function () {
        realm.focusToolbar();
      });
      $_g8b1wa13hjk26infi.query(editor).each(function (link) {
  ...
  var isRecursive = function (component, originator, target) {
    return $_a0tnmgytjk26imdw.eq(originator, component.element()) && !$_a0tnmgytjk26imdw.eq(originator, target);
  };
  ...
  var generateFrom = function (spec, all) {
    ...
    var validated = asStruct('component.behaviours', objOf(schema), spec.behaviours).fold(function (errInfo) {
      throw new Error(formatError(errInfo) + '\nComplete spec:\n' + $_bzno2azhjk26imie.stringify(spec, null, 2));
    }, function (v) {
      return v;
    });
    return {
  ...
  var onlyOne = function (chain, aspect) {
    if (chain.length > 1) {
      return Result.error('Multiple behaviours have tried to change DOM "' + aspect + '". The guilty behaviours are: ' + $_bzno2azhjk26imie.stringify(map$1(chain, function (b) {
        return b.name();
  ...
  var duplicate = function (aspect, k, obj, behaviours) {
    return Result.error('Mulitple behaviours have tried to change the _' + k + '_ "' + aspect + '"' + '. The guilty behaviours are: ' + $_bzno2azhjk26imie.stringify(bind(behaviours, function (b) {
  ...
  var sortKeys = function (label, keyName, array, order) {
    ...
    try {
      var sorted = sliced.sort(function (a, b) {
        ...
        if (aIndex === -1) {
          throw new Error('The ordering for ' + label + ' does not have an entry for ' + aKey + '.\nOrder specified: ' + $_bzno2azhjk26imie.stringify(order, null, 2));
        }
        if (bIndex === -1) {
  ...
  var missingOrderError = function (eventName, tuples) {
    return Result.error(['The event (' + eventName + ') has more than one behaviour that listens to it.\nWhen this occurs, you must ' + 'specify an event ordering for the behaviours in your spec (e.g. [ "listing", "toggling" ]).\nThe behaviours that ' + 'can trigger it are: ' + $_bzno2azhjk26imie.stringify(map$1(tuples, function (c) {
        return c.name();
      }), null, 2)]);
  };
  ...
  var add$3 = function (element, classes) {
    each$1(classes, function (x) {
      $_6f40k8zujk26immd.add(element, x);
    });
  };
  var remove$6 = function (element, classes) {
    each$1(classes, function (x) {
      $_6f40k8zujk26immd.remove(element, x);
    });
  };
  var toggle$3 = function (element, classes) {
    each$1(classes, function (x) {
      $_6f40k8zujk26immd.toggle(element, x);
    });
  };
  var hasAll = function (element, classes) {
    return forall(classes, function (clazz) {
      return $_6f40k8zujk26immd.has(element, clazz);
    });
  };
  ...
  var get$10 = function (element) {
    return $_651504zxjk26immt.supports(element) ? getNative(element) : $_651504zxjk26immt.get(element);
  };
  var $_8a5fs514mjk26int2 = {
    add: add$3,
    remove: remove$6,
    toggle: toggle$3,
    hasAll: hasAll,
  ...
  var renderToDom = function (definition) {
    ...
    $_a03svjzwjk26immh.setAll(subject, definition.attributes().getOr({}));
    $_8a5fs514mjk26int2.add(subject, definition.classes().getOr([]));
    $_34bxt1116jk26imva.setAll(subject, definition.styles().getOr({}));
    $_67epqi10fjk26impi.set(subject, definition.innerHtml().getOr(''));
    var children = getChildren(definition);
    $_c7jzlcz0jk26imeu.append(subject, children);
    definition.value().each(function (value) {
      $_5iwx013tjk26inik.set(subject, value);
    });
    return subject;
  };
  ...
  var build = function (spec) {
    ...
    var syncComponents = function () {
      var children = $_1p1gyhynjk26imd8.children(item);
    ...
    var config = function (behaviour) {
      ...
      var f = isFunction(b[behaviour.name()]) ? b[behaviour.name()] : function () {
        throw new Error('Could not find ' + behaviour.name() + ' in ' + $_bzno2azhjk26imie.stringify(spec, null, 2));
      };
      return f();
    };
  ...
  var onHover = function (item) {
    if ($_1pdvem101jk26imn6.search(item.element()).isNone() || Focusing.isFocused(item)) {
  ...
  var preserve$2 = function (f, container) {
    var ownerDoc = $_1p1gyhynjk26imd8.owner(container);
    var refocus = $_1pdvem101jk26imn6.active(ownerDoc).bind(function (focused) {
      var hasFocus = function (elem) {
        return $_a0tnmgytjk26imdw.eq(focused, elem);
      };
      return hasFocus(container) ? Option.some(container) : $_c54u12103jk26imng.descendant(container, hasFocus);
    });
    var result = f(container);
    refocus.each(function (oldFocus) {
      $_1pdvem101jk26imn6.active(ownerDoc).filter(function (newFocus) {
        return $_a0tnmgytjk26imdw.eq(newFocus, oldFocus);
      }).fold(function () {
        $_1pdvem101jk26imn6.focus(oldFocus);
      }, noop);
    });
    return result;
  };
  ...
  var append$2 = function (component, replaceConfig, replaceState, appendee) {
    insert(component, replaceConfig, $_7esu9pymjk26imd5.append, appendee);
  };
  var prepend$2 = function (component, replaceConfig, replaceState, prependee) {
    insert(component, replaceConfig, $_7esu9pymjk26imd5.prepend, prependee);
  };
  var remove$7 = function (component, replaceConfig, replaceState, removee) {
    var children = contents(component, replaceConfig);
    var foundChild = find$2(children, function (child) {
      return $_a0tnmgytjk26imdw.eq(removee.element(), child.element());
    });
  ...
  var make$3 = function (detail, rawUiSpec) {
    ...
    var updateMenuPath = function (container, state, path) {
      return Option.from(path[0]).bind(state.lookupMenu).map(function (activeMenu) {
        ...
        each$1(rest, function (r) {
          $_6f40k8zujk26immd.add(r.element(), detail.markers().backgroundMenu());
        });
        if (!$_edbrc1yhjk26imc9.inBody(activeMenu.element())) {
          Replacing.append(container, premade$1(activeMenu));
        }
        $_8a5fs514mjk26int2.remove(activeMenu.element(), [detail.markers().backgroundMenu()]);
        setActiveMenu(container, activeMenu);
        var others = getMenus(state, state.otherMenus(path));
        each$1(others, function (o) {
          $_8a5fs514mjk26int2.remove(o.element(), [detail.markers().backgroundMenu()]);
          if (!detail.stayInDom()) {
    ...
    var keyOnItem = function (f) {
      return function (container, simulatedEvent) {
        return $_3ecwyw11bjk26imw8.closest(simulatedEvent.getSource(), '.' + detail.markers().item()).bind(function (target) {
  ...
  var disableTransition = function (comp, transConfig, transState) {
    getTransition(comp, transConfig, transState).each(function (routeTransition) {
      ...
      $_6f40k8zujk26immd.remove(comp.element(), t.transitionClass());
      $_a03svjzwjk26immh.remove(comp.element(), transConfig.destinationAttr());
    });
  };
  var getNewRoute = function (comp, transConfig, transState, destination) {
    return {
      start: constant($_a03svjzwjk26immh.get(comp.element(), transConfig.stateAttr())),
      destination: constant(destination)
    };
  };
  var getCurrentRoute = function (comp, transConfig, transState) {
    var el = comp.element();
    return $_a03svjzwjk26immh.has(el, transConfig.destinationAttr()) ? Option.some({
      start: constant($_a03svjzwjk26immh.get(comp.element(), transConfig.stateAttr())),
      destination: constant($_a03svjzwjk26immh.get(comp.element(), transConfig.destinationAttr()))
    }) : Option.none();
  };
  var jumpTo = function (comp, transConfig, transState, destination) {
    disableTransition(comp, transConfig, transState);
    if ($_a03svjzwjk26immh.has(comp.element(), transConfig.stateAttr()) && $_a03svjzwjk26immh.get(comp.element(), transConfig.stateAttr()) !== destination) {
      transConfig.onFinish()(comp, destination);
    }
    $_a03svjzwjk26immh.set(comp.element(), transConfig.stateAttr(), destination);
  };
  var fasttrack = function (comp, transConfig, transState, destination) {
    if ($_a03svjzwjk26immh.has(comp.element(), transConfig.destinationAttr())) {
      $_a03svjzwjk26immh.set(comp.element(), transConfig.stateAttr(), $_a03svjzwjk26immh.get(comp.element(), transConfig.destinationAttr()));
      $_a03svjzwjk26immh.remove(comp.element(), transConfig.destinationAttr());
    }
  };
  var progressTo = function (comp, transConfig, transState, destination) {
    ...
    getTransitionOf(comp, transConfig, transState, route).fold(function () {
      ...
      disableTransition(comp, transConfig, transState);
      var t = routeTransition.transition();
      $_6f40k8zujk26immd.add(comp.element(), t.transitionClass());
      $_a03svjzwjk26immh.set(comp.element(), transConfig.destinationAttr(), destination);
    });
  };
  var getState = function (comp, transConfig, transState) {
    var e = comp.element();
    return $_a03svjzwjk26immh.has(e, transConfig.stateAttr()) ? Option.some($_a03svjzwjk26immh.get(e, transConfig.stateAttr())) : Option.none();
  };
  ...
  var scrollable = $_b7z5dh10tjk26imst.resolve('scrollable');
  var register = function (element) {
    $_6f40k8zujk26immd.add(element, scrollable);
  };
  var deregister = function (element) {
    $_6f40k8zujk26immd.remove(element, scrollable);
  };
  var $_l0ct2159jk26io0s = {
    register: register,
  ...
  var makeItem = function (value, text$$1, selected, preview, isMenu) {
    return {
      ...
      dom: {
        tag: 'div',
        classes: isMenu ? [$_b7z5dh10tjk26imst.resolve('styles-item-is-menu')] : []
      },
      toggling: {
        toggleOnExecute: false,
        toggleClass: $_b7z5dh10tjk26imst.resolve('format-matches'),
        selected: selected
      },
      itemBehaviours: derive$2(isMenu ? [] : [$_ashibi10sjk26imso.format(value, function (comp, status) {
          var toggle = status ? Toggling.on : Toggling.off;
          toggle(comp);
        })]),
      components: [{
    ...
    return {
      ...
      components: [
        Button.sketch({
          dom: {
            tag: 'div',
            classes: [$_b7z5dh10tjk26imst.resolve('styles-collapser')]
          },
          components: collapsable ? [
            {
              dom: {
                tag: 'span',
                classes: [$_b7z5dh10tjk26imst.resolve('styles-collapse-icon')]
              }
            },
            text(value)
          ] : [text(value)],
        ...
        }),
        {
          dom: {
            tag: 'div',
            classes: [$_b7z5dh10tjk26imst.resolve('styles-menu-items-container')]
          },
          components: [Menu.parts().items({})],
          behaviours: derive$2([config('adhoc-scrollable-menu', [
              runOnAttached(function (component, simulatedEvent) {
                $_34bxt1116jk26imva.set(component.element(), 'overflow-y', 'auto');
                $_34bxt1116jk26imva.set(component.element(), '-webkit-overflow-scrolling', 'touch');
                $_l0ct2159jk26io0s.register(component.element());
              }),
              runOnDetached(function (component) {
                $_34bxt1116jk26imva.remove(component.element(), 'overflow-y');
                $_34bxt1116jk26imva.remove(component.element(), '-webkit-overflow-scrolling');
                $_l0ct2159jk26io0s.deregister(component.element());
              })
            ])])
        }
      ],
  ...
  var sketch$9 = function (settings) {
    ...
    var memMenu = record(tieredMenu.sketch({
      dom: {
        tag: 'div',
        classes: [$_b7z5dh10tjk26imst.resolve('styles-menu')]
      },
      components: [],
      fakeFocus: true,
      stayInDom: true,
      ...
      onOpenMenu: function (container, menu) {
        var w = $_1yqkk6130jk26incg.get(container.element());
        $_1yqkk6130jk26incg.set(menu.element(), w);
        Transitioning.jumpTo(menu, 'current');
      },
      onOpenSubmenu: function (container, item, submenu) {
        var w = $_1yqkk6130jk26incg.get(container.element());
        var menu = $_3ecwyw11bjk26imw8.ancestor(item.element(), '[role="menu"]').getOrDie('hacky');
        var menuComp = container.getSystem().getByDom(menu).getOrDie();
        $_1yqkk6130jk26incg.set(submenu.element(), w);
        Transitioning.progressTo(menuComp, 'before');
        Transitioning.jumpTo(submenu, 'after');
        Transitioning.progressTo(submenu, 'current');
      },
      onCollapseMenu: function (container, item, menu) {
        var submenu = $_3ecwyw11bjk26imw8.ancestor(item.element(), '[role="menu"]').getOrDie('hacky');
      ...
      data: dataset.tmenu,
      markers: {
        backgroundMenu: $_b7z5dh10tjk26imst.resolve('styles-background-menu'),
        menu: $_b7z5dh10tjk26imst.resolve('styles-menu'),
        selectedMenu: $_b7z5dh10tjk26imst.resolve('styles-selected-menu'),
        item: $_b7z5dh10tjk26imst.resolve('styles-item'),
        selectedItem: $_b7z5dh10tjk26imst.resolve('styles-selected-item')
      }
    }));
    return memMenu.asSpec();
  };
  var $_y0u9r147jk26inlw = { sketch: sketch$9 };
  ...
  var $_ank52s15ajk26io0z = { expand: expand };
  ...
  var prune = function (editor, formats) {
    ...
    return $_ank52s15ajk26io0z.expand(prunedItems);
  };
  var ui = function (editor, formats, onDone) {
    var pruned = prune(editor, formats);
    return $_y0u9r147jk26inlw.sketch({
      formats: pruned,
  ...
  var setup = function (realm, editor) {
    var commandSketch = function (name) {
      return function () {
        return $_eugz1f10ujk26imsw.forToolbarCommand(editor, name);
      };
    };
    var stateCommandSketch = function (name) {
      return function () {
        return $_eugz1f10ujk26imsw.forToolbarStateCommand(editor, name);
      };
    };
    var actionSketch = function (name, query, action) {
      return function () {
        return $_eugz1f10ujk26imsw.forToolbarStateAction(editor, name, query, action);
      };
    };
    ...
    var forecolor = function () {
      return $_c60rrv12kjk26in90.sketch(realm, editor);
    };
    var styleFormats = $_9yqsll145jk26inlg.register(editor, editor.settings);
    var styleFormatsMenu = function () {
      return $_9yqsll145jk26inlg.ui(editor, styleFormats, function () {
        editor.fire('scrollIntoView');
      });
    };
    var styleselect = function () {
      return $_eugz1f10ujk26imsw.forToolbar('style-formats', function (button) {
        ...
        Receiving.config({
          channels: wrapAll$1([
            $_ashibi10sjk26imso.receive($_7t51r1109jk26imo8.orientationChanged(), Toggling.off),
            $_ashibi10sjk26imso.receive($_7t51r1109jk26imo8.dropupDismissed(), Toggling.off)
          ])
        })
      ]));
    };
  ...
  var bind$2 = function (element, event, handler) {
    return $_a4ks2o15djk26io1s.bind(element, event, filter$1, handler);
  };
  var capture$1 = function (element, event, handler) {
    return $_a4ks2o15djk26io1s.capture(element, event, filter$1, handler);
  };
  var $_99ykra15cjk26io1m = {
    bind: bind$2,
    capture: capture$1
  };
  ...
  var getActualWidth = function (outerWindow) {
    var isIos = $_5mqjb5y3jk26imac.detect().os.isiOS();
  ...
  var onChange = function (outerWindow, listeners) {
    ...
    var orientationHandle = $_99ykra15cjk26io1m.bind(win, 'orientationchange', change);
  ...
  var monitor = function (settings) {
    ...
    var handleTouchend = function (event) {
      ...
      var isSame = function (data) {
        return $_a0tnmgytjk26imdw.eq(data.target(), event.target());
      };
  ...
  var monitor$1 = function (editorApi) {
    ...
    var onTouchend = function () {
      return $_99ykra15cjk26io1m.bind(editorApi.body(), 'touchend', function (evt) {
        tapEvent.fireIfReady(evt, 'touchend');
      });
    };
    var onTouchmove = function () {
      return $_99ykra15cjk26io1m.bind(editorApi.body(), 'touchmove', function (evt) {
  ...
  var $_6utlwm15ijk26io3e = { monitor: monitor$1 };

  var isAndroid6 = $_5mqjb5y3jk26imac.detect().os.version.major >= 6;
  var initEvents = function (editorApi, toolstrip, alloy) {
    var tapping = $_6utlwm15ijk26io3e.monitor(editorApi);
    var outerDoc = $_1p1gyhynjk26imd8.owner(toolstrip);
    var isRanged = function (sel) {
      return !$_a0tnmgytjk26imdw.eq(sel.start(), sel.finish()) || sel.soffset() !== sel.foffset();
    };
    var hasRangeInUi = function () {
      return $_1pdvem101jk26imn6.active(outerDoc).filter(function (input) {
        return $_28nlgkykjk26imd2.name(input) === 'input';
    ...
    var listeners = [
      $_99ykra15cjk26io1m.bind(editorApi.body(), 'touchstart', function (evt) {
        editorApi.onTouchContent();
        tapping.fireTouchstart(evt);
      }),
      tapping.onTouchmove(),
      tapping.onTouchend(),
      $_99ykra15cjk26io1m.bind(toolstrip, 'touchstart', function (evt) {
        editorApi.onTouchToolstrip();
      }),
      editorApi.onToReading(function () {
        $_1pdvem101jk26imn6.blur(editorApi.body());
      }),
      ...
      $_99ykra15cjk26io1m.bind(Element$$1.fromDom(editorApi.win()), 'blur', function () {
        alloy.getByDom(toolstrip).each(Toggling.off);
      }),
      $_99ykra15cjk26io1m.bind(outerDoc, 'select', updateMargin),
      $_99ykra15cjk26io1m.bind(editorApi.doc(), 'selectionchange', updateMargin)
    ]);
    var destroy = function () {
  ...
  var $_eryhvo15hjk26io2m = { initEvents: initEvents };

  var safeParse = function (element, attribute) {
    var parsed = parseInt($_a03svjzwjk26immh.get(element, attribute), 10);
    return isNaN(parsed) ? 0 : parsed;
  };
  var $_47wscg15mjk26io4h = { safeParse: safeParse };
  ...
  var api$3 = NodeValue($_28nlgkykjk26imd2.isText, 'text');
  ...
  var getEnd = function (element) {
    return $_28nlgkykjk26imd2.name(element) === 'img' ? 1 : $_1bbksb15pjk26io55.getOption(element).fold(function () {
      return $_1p1gyhynjk26imd8.children(element).length;
    }, function (v) {
      return v.length;
    });
  };
  ...
  var isTextNodeWithCursorPosition = function (el) {
    return $_1bbksb15pjk26io55.getOption(el).filter(function (text) {
  ...
  var isCursorPosition = function (elem) {
    ...
    return hasCursorPosition || contains(elementsWithCursorPosition, $_28nlgkykjk26imd2.name(elem));
  };
  var $_d1knqk15ojk26io50 = {
    getEnd: getEnd,
    isEnd: isEnd,
    isStart: isStart,
  ...
  var getStart$1 = function (selection) {
    return selection.match({
      ...
      relative: function (startSitu, finishSitu) {
        return $_htc6m15sjk26io5o.getStart(startSitu);
      },
  ...
  var getWin = function (selection) {
    ...
    return $_1p1gyhynjk26imd8.defaultView(start);
  };
  var $_dqste715rjk26io5h = {
  ...
  var makeRange = function (start, soffset, finish, foffset) {
    var doc = $_1p1gyhynjk26imd8.owner(start);
  ...
  var after$2 = function (start, soffset, finish, foffset) {
    var r = makeRange(start, soffset, finish, foffset);
    var same = $_a0tnmgytjk26imdw.eq(start, finish) && soffset === foffset;
    return r.collapsed && !same;
  };
  var $_37rfsm15ujk26io61 = {
    after: after$2,
  ...
  var $_f6l48u15vjk26io63 = { fromElements: fromElements };
  ...
  var getRanges = function (win, selection) {
    return selection.match({
      ...
      relative: function (startSitu, finishSitu) {
        return {
          ltr: cached(function () {
            return $_ttnhm15wjk26io68.relativeToNative(win, startSitu, finishSitu);
          }),
          rtl: cached(function () {
            return Option.some($_ttnhm15wjk26io68.relativeToNative(win, finishSitu, startSitu));
          })
        };
      },
      exact: function (start, soffset, finish, foffset) {
        return {
          ltr: cached(function () {
            return $_ttnhm15wjk26io68.exactToNative(win, start, soffset, finish, foffset);
          }),
          rtl: cached(function () {
            return Option.some($_ttnhm15wjk26io68.exactToNative(win, finish, foffset, start, soffset));
          })
        };
      }
    });
  ...
  var locateOffset = function (doc, textnode, x, y, rect) {
    ...
    var length = $_1bbksb15pjk26io55.get(textnode).length;
    var offset = $_8ozh7j160jk26io78.searchForPoint(rectForOffset, x, y, rect.right, length);
  ...
  var locate$1 = function (doc, node, x, y) {
    ...
    var foundRect = findMap(rects, function (rect) {
      return $_8ozh7j160jk26io78.inRect(rect, x, y) ? Option.some(rect) : Option.none();
    });
    return foundRect.map(function (rect) {
      return locateOffset(doc, node, x, y, rect);
    });
  };
  var $_34ly30161jk26io79 = { locate: locate$1 };

  var searchInChildren = function (doc, node, x, y) {
    var r = doc.dom().createRange();
    var nodes = $_1p1gyhynjk26imd8.children(node);
    return findMap(nodes, function (n) {
      r.selectNode(n.dom());
      return $_8ozh7j160jk26io78.inRect(r.getBoundingClientRect(), x, y) ? locateNode(doc, n, x, y) : Option.none();
    });
  };
  var locateNode = function (doc, node, x, y) {
    var locator = $_28nlgkykjk26imd2.isText(node) ? $_34ly30161jk26io79.locate : searchInChildren;
  ...
  var $_5g6zor15zjk26io70 = { locate: locate$2 };

  var first$3 = function (element) {
    return $_c54u12103jk26imng.descendant(element, $_d1knqk15ojk26io50.isCursorPosition);
  };
  var last$2 = function (element) {
    return descendantRtl(element, $_d1knqk15ojk26io50.isCursorPosition);
  };
  var descendantRtl = function (scope, predicate) {
    var descend = function (element) {
      var children = $_1p1gyhynjk26imd8.children(element);
  ...
  var locateInElement = function (doc, node, x) {
    ...
    var f = collapseDirection === COLLAPSE_TO_LEFT ? $_30s5is163jk26io7p.first : $_30s5is163jk26io7p.last;
  ...
  var search$1 = function (doc, node, x) {
    var f = $_1p1gyhynjk26imd8.children(node).length === 0 ? locateInEmpty : locateInElement;
    return f(doc, node, x);
  };
  var $_2g8dcn162jk26io7h = { search: search$1 };
  ...
  var searchTextNodes = function (doc, node, x, y) {
    ...
    var boundedX = Math.max(rect.left, Math.min(rect.right, x));
    var boundedY = Math.max(rect.top, Math.min(rect.bottom, y));
    return $_5g6zor15zjk26io70.locate(doc, node, boundedX, boundedY);
  };
  var searchFromPoint = function (doc, x, y) {
    return Element$$1.fromPoint(doc, x, y).bind(function (elem) {
      var fallback = function () {
        return $_2g8dcn162jk26io7h.search(doc, elem, x);
      };
      return $_1p1gyhynjk26imd8.children(elem).length === 0 ? fallback() : searchTextNodes(doc, elem, x, y).orThunk(fallback);
    });
  };
  ...
  var fromPoint$1 = function (win, x, y) {
    ...
    return availableSearch(doc, x, y).map(function (rng) {
      return $_dqste715rjk26io5h.range(Element$$1.fromDom(rng.startContainer), rng.startOffset, Element$$1.fromDom(rng.endContainer), rng.endOffset);
    });
  };
  var $_df9fc715yjk26io6u = { fromPoint: fromPoint$1 };

  var withinContainer = function (win, ancestor, outerRange, selector) {
    var innerRange = $_ttnhm15wjk26io68.create(win);
    var self = $_7ctcwnyyjk26imef.is(ancestor, selector) ? [ancestor] : [];
    var elements = self.concat($_1roeab119jk26imw0.descendants(ancestor, selector));
    return filter(elements, function (elem) {
      $_ttnhm15wjk26io68.selectNodeContentsUsing(innerRange, elem);
      return $_ttnhm15wjk26io68.isWithin(outerRange, innerRange);
    });
  };
  var find$3 = function (win, selection, selector) {
    var outerRange = $_40s3lb15xjk26io6h.asLtrRange(win, selection);
    var ancestor = Element$$1.fromDom(outerRange.commonAncestorContainer);
    return $_28nlgkykjk26imd2.isElement(ancestor) ? withinContainer(win, ancestor, outerRange, selector) : [];
  };
  var $_4fhya7164jk26io7t = { find: find$3 };

  var beforeSpecial = function (element, offset) {
    var name = $_28nlgkykjk26imd2.name(element);
    if ('input' === name)
      return $_htc6m15sjk26io5o.after(element);
    else if (!contains([
        'br',
        'img'
      ], name))
      return $_htc6m15sjk26io5o.on(element, offset);
    else
      return offset === 0 ? $_htc6m15sjk26io5o.before(element) : $_htc6m15sjk26io5o.after(element);
  };
  var preprocessRelative = function (startSitu, finishSitu) {
    var start = startSitu.fold($_htc6m15sjk26io5o.before, beforeSpecial, $_htc6m15sjk26io5o.after);
    var finish = finishSitu.fold($_htc6m15sjk26io5o.before, beforeSpecial, $_htc6m15sjk26io5o.after);
    return $_dqste715rjk26io5h.relative(start, finish);
  };
  var preprocessExact = function (start, soffset, finish, foffset) {
    var startSitu = beforeSpecial(start, soffset);
    var finishSitu = beforeSpecial(finish, foffset);
    return $_dqste715rjk26io5h.relative(startSitu, finishSitu);
  };
  ...
  var doSetRange = function (win, start, soffset, finish, foffset) {
    var rng = $_ttnhm15wjk26io68.exactToNative(win, start, soffset, finish, foffset);
    doSetNativeRange(win, rng);
  };
  var findWithin = function (win, selection, selector) {
    return $_4fhya7164jk26io7t.find(win, selection, selector);
  };
  ...
  var setRangeFromRelative = function (win, relative) {
    return $_40s3lb15xjk26io6h.diagnose(win, relative).match({
      ltr: function (start, soffset, finish, foffset) {
  ...
  var setExact = function (win, start, soffset, finish, foffset) {
    var relative = $_bdkqkt165jk26io7y.preprocessExact(start, soffset, finish, foffset);
    setRangeFromRelative(win, relative);
  };
  var setRelative = function (win, startSitu, finishSitu) {
    var relative = $_bdkqkt165jk26io7y.preprocessRelative(startSitu, finishSitu);
    setRangeFromRelative(win, relative);
  };
  var toNative = function (selection) {
    var win = $_dqste715rjk26io5h.getWin(selection).dom();
    var getDomRange = function (start, soffset, finish, foffset) {
      return $_ttnhm15wjk26io68.exactToNative(win, start, soffset, finish, foffset);
    };
    var filtered = $_bdkqkt165jk26io7y.preprocess(selection);
    return $_40s3lb15xjk26io6h.diagnose(win, filtered).match({
      ltr: getDomRange,
      rtl: getDomRange
    });
  };
  var readRange = function (selection) {
    if (selection.rangeCount > 0) {
      ...
      return Option.some($_dqste715rjk26io5h.range(Element$$1.fromDom(firstRng.startContainer), firstRng.startOffset, Element$$1.fromDom(lastRng.endContainer), lastRng.endOffset));
    } else {
      return Option.none();
    }
  };
  var doGetExact = function (selection) {
    ...
    return $_37rfsm15ujk26io61.after(anchorNode, selection.anchorOffset, focusNode, selection.focusOffset) ? Option.some($_dqste715rjk26io5h.range(Element$$1.fromDom(selection.anchorNode), selection.anchorOffset, Element$$1.fromDom(selection.focusNode), selection.focusOffset)) : readRange(selection);
  };
  var setToElement = function (win, element) {
    var rng = $_ttnhm15wjk26io68.selectNodeContents(win, element);
    doSetNativeRange(win, rng);
  };
  ...
  var get$13 = function (win) {
    return getExact(win).map(function (range) {
      return $_dqste715rjk26io5h.exact(range.start(), range.soffset(), range.finish(), range.foffset());
    });
  };
  var getFirstRect$1 = function (win, selection) {
    var rng = $_40s3lb15xjk26io6h.asLtrRange(win, selection);
    return $_ttnhm15wjk26io68.getFirstRect(rng);
  };
  var getBounds$1 = function (win, selection) {
    var rng = $_40s3lb15xjk26io6h.asLtrRange(win, selection);
    return $_ttnhm15wjk26io68.getBounds(rng);
  };
  var getAtPoint = function (win, x, y) {
    return $_df9fc715yjk26io6u.fromPoint(win, x, y);
  };
  var getAsString = function (win, selection) {
    var rng = $_40s3lb15xjk26io6h.asLtrRange(win, selection);
    return $_ttnhm15wjk26io68.toString(rng);
  };
  ...
  var clone$3 = function (win, selection) {
    var rng = $_40s3lb15xjk26io6h.asLtrRange(win, selection);
    return $_ttnhm15wjk26io68.cloneFragment(rng);
  };
  var replace = function (win, selection, elements) {
    var rng = $_40s3lb15xjk26io6h.asLtrRange(win, selection);
    var fragment = $_f6l48u15vjk26io63.fromElements(elements, win.document);
    $_ttnhm15wjk26io68.replaceWith(rng, fragment);
  };
  var deleteAt = function (win, selection) {
    var rng = $_40s3lb15xjk26io6h.asLtrRange(win, selection);
    $_ttnhm15wjk26io68.deleteContents(rng);
  };
  var isCollapsed = function (start, soffset, finish, foffset) {
    return $_a0tnmgytjk26imdw.eq(start, finish) && soffset === foffset;
  };
  var $_c84ysh15tjk26io5v = {
    setExact: setExact,
    getExact: getExact,
    get: get$13,
  ...
  var getRectsFromRange = function (range$$1) {
    if (!range$$1.collapsed) {
      ...
      return $_1p1gyhynjk26imd8.parent(start_1).bind(function (parent) {
        var selection = $_dqste715rjk26io5h.exact(start_1, range$$1.startOffset, parent, $_d1knqk15ojk26io50.getEnd(parent));
        var optRect = $_c84ysh15tjk26io5v.getFirstRect(range$$1.startContainer.ownerDocument.defaultView, selection);
  ...
  var $_fkzq2u15njk26io4j = { getRectangles: getRectangles };
  ...
  var resume = function (cWin) {
    ...
    var inInput = $_1pdvem101jk26imn6.active().exists(function (elem) {
      return contains([
        'input',
        'textarea'
      ], $_28nlgkykjk26imd2.name(elem));
    });
    var transaction = inInput ? autocompleteHack() : apply;
    transaction(function () {
      $_1pdvem101jk26imn6.active().each($_1pdvem101jk26imn6.blur);
      $_1pdvem101jk26imn6.focus(iBody);
    });
  };
  var $_f4k0so166jk26io83 = { resume: resume };

  var EXTRA_SPACING = 50;
  var data = 'data-' + $_b7z5dh10tjk26imst.resolve('last-outer-height');
  var setLastHeight = function (cBody, value) {
    $_a03svjzwjk26immh.set(cBody, data, value);
  };
  var getLastHeight = function (cBody) {
    return $_47wscg15mjk26io4h.safeParse(cBody, data);
  };
  ...
  var getBounds$2 = function (cWin) {
    var rects = $_fkzq2u15njk26io4j.getRectangles(cWin);
  ...
  var setup$1 = function (outerWindow, cWin) {
    ...
    var toEditing = function () {
      $_f4k0so166jk26io83.resume(cWin);
    };
    var onResize = $_99ykra15cjk26io1m.bind(Element$$1.fromDom(outerWindow), 'resize', function () {
  ...
  var $_8p3ds015ljk26io43 = { setup: setup$1 };
  ...
  var getSelectionFromFrame = function (frame) {
    ...
    return optWin.bind($_c84ysh15tjk26io5v.getExact);
  };
  ...
  var getOrListen = function (editor, doc, name, type) {
    return editor[name].getOrThunk(function () {
      return function (handler) {
        return $_99ykra15cjk26io1m.bind(doc, type, handler);
      };
    });
  };
  ...
  var getActiveApi = function (editor) {
    ...
    var tryFallbackBox = function (win) {
      ...
      return $_c84ysh15tjk26io5v.getExact(win).filter(isCollapsed).bind(toStartRect);
    };
      ...
      return getDocFromFrame(frame).bind(function (doc) {
        return getWinFromFrame(frame).map(function (win) {
          ...
          var getCursorBox = editor.getCursorBox.getOrThunk(function () {
            return function () {
              return $_c84ysh15tjk26io5v.get(win).bind(function (sel) {
                return $_c84ysh15tjk26io5v.getFirstRect(win, sel).orThunk(function () {
          ...
          var setSelection = editor.setSelection.getOrThunk(function () {
            return function (start, soffset, finish, foffset) {
              $_c84ysh15tjk26io5v.setExact(win, start, soffset, finish, foffset);
            };
          });
          var clearSelection = editor.clearSelection.getOrThunk(function () {
            return function () {
              $_c84ysh15tjk26io5v.clear(win);
            };
          });
          return {
            body: constant(body),
  ...
  var isAndroid = $_5mqjb5y3jk26imac.detect().os.isAndroid();
  var matchColor = function (editorBody) {
    var color = $_34bxt1116jk26imva.get(editorBody, 'background-color');
    return color !== undefined && color !== '' ? 'background-color:' + color + '!important' : bgFallback;
  };
  var clobberStyles = function (container, editorBody) {
    var gatherSibilings = function (element) {
      var siblings = $_1roeab119jk26imw0.siblings(element, '*');
      return siblings;
    };
    var clobber = function (clobberStyle) {
      return function (element) {
        var styles = $_a03svjzwjk26immh.get(element, 'style');
        var backup = styles === undefined ? 'no-styles' : styles.trim();
        if (backup === clobberStyle) {
          return;
        } else {
          $_a03svjzwjk26immh.set(element, attr, backup);
          $_a03svjzwjk26immh.set(element, 'style', clobberStyle);
        }
      };
    };
    var ancestors = $_1roeab119jk26imw0.ancestors(container, '*');
  ...
  var restoreStyles = function () {
    var clobberedEls = $_1roeab119jk26imw0.all('[' + attr + ']');
    each$1(clobberedEls, function (element) {
      var restore = $_a03svjzwjk26immh.get(element, attr);
      if (restore !== 'no-styles') {
        $_a03svjzwjk26immh.set(element, 'style', restore);
      } else {
        $_a03svjzwjk26immh.remove(element, 'style');
      }
      $_a03svjzwjk26immh.remove(element, attr);
  ...
  var $_c8t6pz168jk26io8w = {
    clobberStyles: clobberStyles,
    restoreStyles: restoreStyles
  };

  var tag = function () {
    var head = $_3ecwyw11bjk26imw8.first('head').getOrDie();
    var nu = function () {
      var meta = Element$$1.fromTag('meta');
      $_a03svjzwjk26immh.set(meta, 'name', 'viewport');
      $_7esu9pymjk26imd5.append(head, meta);
      return meta;
    };
    var element = $_3ecwyw11bjk26imw8.first('meta[name="viewport"]').getOrThunk(nu);
    var backup = $_a03svjzwjk26immh.get(element, 'content');
    var maximize = function () {
      $_a03svjzwjk26immh.set(element, 'content', 'width=device-width, initial-scale=1.0, user-scalable=no, maximum-scale=1.0');
    };
    var restore = function () {
      if (backup !== undefined && backup !== null && backup.length > 0) {
        $_a03svjzwjk26immh.set(element, 'content', backup);
      } else {
        $_a03svjzwjk26immh.set(element, 'content', 'user-scalable=yes');
      }
    };
    return {
      maximize: maximize,
  ...
  var $_c0sbpw169jk26io98 = { tag: tag };

  var create$5 = function (platform, mask) {
    var meta = $_c0sbpw169jk26io98.tag();
    var androidApi = api$2();
    var androidEvents = api$2();
    var enter = function () {
      mask.hide();
      $_6f40k8zujk26immd.add(platform.container, $_b7z5dh10tjk26imst.resolve('fullscreen-maximized'));
      $_6f40k8zujk26immd.add(platform.container, $_b7z5dh10tjk26imst.resolve('android-maximized'));
      meta.maximize();
      $_6f40k8zujk26immd.add(platform.body, $_b7z5dh10tjk26imst.resolve('android-scroll-reload'));
      androidApi.set($_8p3ds015ljk26io43.setup(platform.win, $_f7wr9d167jk26io8g.getWin(platform.editor).getOrDie('no')));
      $_f7wr9d167jk26io8g.getActiveApi(platform.editor).each(function (editorApi) {
        $_c8t6pz168jk26io8w.clobberStyles(platform.container, editorApi.body());
        androidEvents.set($_eryhvo15hjk26io2m.initEvents(editorApi, platform.toolstrip, platform.alloy));
      });
    };
    var exit = function () {
      meta.restore();
      mask.show();
      $_6f40k8zujk26immd.remove(platform.container, $_b7z5dh10tjk26imst.resolve('fullscreen-maximized'));
      $_6f40k8zujk26immd.remove(platform.container, $_b7z5dh10tjk26imst.resolve('android-maximized'));
      $_c8t6pz168jk26io8w.restoreStyles();
      $_6f40k8zujk26immd.remove(platform.body, $_b7z5dh10tjk26imst.resolve('android-scroll-reload'));
      androidEvents.clear();
      androidApi.clear();
    };
    return {
  ...
  var $_1sww2h15gjk26io2g = { create: create$5 };
  ...
  var sketch$10 = function (onView, translate) {
    var memIcon = record(Container.sketch({
      ...
      containerBehaviours: derive$2([Toggling.config({
          toggleClass: $_b7z5dh10tjk26imst.resolve('mask-tap-icon-selected'),
          toggleOnExecute: false
        })])
    }));
    ...
    return Container.sketch({
      ...
      components: [Container.sketch({
          ...
          components: [Button.sketch({
              ...
              buttonBehaviours: derive$2([Toggling.config({ toggleClass: $_b7z5dh10tjk26imst.resolve('mask-tap-icon-selected') })])
            })]
        })]
    });
  };
  var $_8bpqjl16ajk26io9j = { sketch: sketch$10 };
  ...
  var MobileSchema = objOf([
    ...
    state$1('win', function (spec) {
      return $_1p1gyhynjk26imd8.owner(spec.socket).dom().defaultView;
    }),
  ...
  var produce = function (raw) {
    ...
    $_34bxt1116jk26imva.set(mobile.toolstrip, 'width', '100%');
    var onTap = function () {
      mobile.setReadOnly(mobile.readOnlyOnInit());
      mode.enter();
    };
    var mask = build$1($_8bpqjl16ajk26io9j.sketch(onTap, mobile.translate));
    ...
    $_7esu9pymjk26imd5.append(mobile.container, mask.element());
    var mode = $_1sww2h15gjk26io2g.create(mobile, maskApi);
    return {
  ...
  var $_gfhwpr15fjk26io25 = { produce: produce };
  ...
  var dataHorizontal = 'data-' + $_b7z5dh10tjk26imst.resolve('horizontal-scroll');
  ...
  var markAsHorizontal = function (container) {
    $_a03svjzwjk26immh.set(container, dataHorizontal, 'true');
  };
  var hasScroll = function (container) {
    return $_a03svjzwjk26immh.get(container, dataHorizontal) === 'true' ? hasHorizontalScroll(container) : hasVerticalScroll(container);
  };
  var exclusive = function (scope, selector) {
    return $_99ykra15cjk26io1m.bind(scope, 'touchmove', function (event) {
      $_3ecwyw11bjk26imw8.closest(event.target(), selector).filter(hasScroll).fold(function () {
        event.raw().preventDefault();
      }, noop);
    });
  };
  var $_dkrdny16ijk26ioc8 = {
    exclusive: exclusive,
  ...
  function ScrollingToolbar () {
    var makeGroup = function (gSpec) {
      ...
      return {
        ...
        tgroupBehaviours: derive$2([config('adhoc-scrollable-toolbar', gSpec.scrollable === true ? [runOnInit(function (component, simulatedEvent) {
              $_34bxt1116jk26imva.set(component.element(), 'overflow-x', 'auto');
              $_dkrdny16ijk26ioc8.markAsHorizontal(component.element());
              $_l0ct2159jk26io0s.register(component.element());
            })] : [])]),
        components: [Container.sketch({ components: [ToolbarGroup.parts().items({})] })],
        markers: { itemClass: $_b7z5dh10tjk26imst.resolve('toolbar-group-item') },
        items: gSpec.items
      };
    };
    var toolbar = build$1(Toolbar.sketch({
      ...
      toolbarBehaviours: derive$2([
        Toggling.config({
          toggleClass: $_b7z5dh10tjk26imst.resolve('context-toolbar'),
          toggleOnExecute: false,
          aria: { mode: 'none' }
        }),
    ...
    var wrapper = build$1(Container.sketch({
      dom: { classes: [$_b7z5dh10tjk26imst.resolve('toolstrip')] },
      components: [premade$1(toolbar)],
      containerBehaviours: derive$2([Toggling.config({
          toggleClass: $_b7z5dh10tjk26imst.resolve('android-selection-context-toolbar'),
          toggleOnExecute: false
        })])
    }));
  ...
  var disableTransitions = function (component, slideConfig) {
    ...
    $_8a5fs514mjk26int2.remove(root, [
      slideConfig.shrinkingClass(),
      slideConfig.growingClass()
    ]);
  };
  var setShrunk = function (component, slideConfig) {
    $_6f40k8zujk26immd.remove(component.element(), slideConfig.openClass());
    $_6f40k8zujk26immd.add(component.element(), slideConfig.closedClass());
    $_34bxt1116jk26imva.set(component.element(), getDimensionProperty(slideConfig), '0px');
    $_34bxt1116jk26imva.reflow(component.element());
  };
  ...
  var setGrown = function (component, slideConfig) {
    $_6f40k8zujk26immd.remove(component.element(), slideConfig.closedClass());
    $_6f40k8zujk26immd.add(component.element(), slideConfig.openClass());
    $_34bxt1116jk26imva.remove(component.element(), getDimensionProperty(slideConfig));
  };
  var doImmediateShrink = function (component, slideConfig, slideState) {
    slideState.setCollapsed();
    $_34bxt1116jk26imva.set(component.element(), getDimensionProperty(slideConfig), getDimension(slideConfig, component.element()));
    $_34bxt1116jk26imva.reflow(component.element());
  ...
  var doStartShrink = function (component, slideConfig, slideState) {
    ...
    $_34bxt1116jk26imva.reflow(component.element());
    var root = getAnimationRoot(component, slideConfig);
    $_6f40k8zujk26immd.add(root, slideConfig.shrinkingClass());
    setShrunk(component, slideConfig);
    slideConfig.onStartShrink()(component);
  };
  var doStartGrow = function (component, slideConfig, slideState) {
    ...
    var root = getAnimationRoot(component, slideConfig);
    $_6f40k8zujk26immd.add(root, slideConfig.growingClass());
    setGrown(component, slideConfig);
    $_34bxt1116jk26imva.set(component.element(), getDimensionProperty(slideConfig), fullSize);
  ...
  var isGrowing = function (component, slideConfig, slideState) {
    var root = getAnimationRoot(component, slideConfig);
    return $_6f40k8zujk26immd.has(root, slideConfig.growingClass()) === true;
  };
  var isShrinking = function (component, slideConfig, slideState) {
    var root = getAnimationRoot(component, slideConfig);
    return $_6f40k8zujk26immd.has(root, slideConfig.shrinkingClass()) === true;
  };
  ...
  var events$10 = function (slideConfig, slideState) {
    return derive([run(transitionend(), function (component, simulatedEvent) {
        ...
        if (raw.propertyName === slideConfig.dimension().property()) {
          disableTransitions(component, slideConfig);
          if (slideState.isExpanded()) {
            $_34bxt1116jk26imva.remove(component.element(), slideConfig.dimension().property());
          }
    ...
    strictOf('dimension', choose$1('property', {
      width: [
        ...
        output$1('getDimension', function (elem) {
          return $_1yqkk6130jk26incg.get(elem) + 'px';
        })
      ],
      height: [
        output$1('property', 'height'),
        output$1('getDimension', function (elem) {
          return $_c1p1ek115jk26imv8.get(elem) + 'px';
        })
      ]
    }))
  ];
  ...
  var build$2 = function (refresh, scrollIntoView) {
    var dropup = build$1(Container.sketch({
      dom: {
        tag: 'div',
        classes: [$_b7z5dh10tjk26imst.resolve('dropup')]
      },
      components: [],
      containerBehaviours: derive$2([
        Replacing.config({}),
        Sliding.config({
          closedClass: $_b7z5dh10tjk26imst.resolve('dropup-closed'),
          openClass: $_b7z5dh10tjk26imst.resolve('dropup-open'),
          shrinkingClass: $_b7z5dh10tjk26imst.resolve('dropup-shrinking'),
          growingClass: $_b7z5dh10tjk26imst.resolve('dropup-growing'),
        ...
        $_ashibi10sjk26imso.orientation(function (component, data) {
          disappear(noop);
        })
      ])
    }));
  ...
  var isDangerous = function (event$$1) {
    ...
    return keyEv.which === BACKSPACE()[0] && !contains([
      'input',
      'textarea'
    ], $_28nlgkykjk26imd2.name(event$$1.target()));
  };
  var isFirefox = $_5mqjb5y3jk26imac.detect().browser.isFirefox();
  ...
  var bindFocus = function (container, handler) {
    if (isFirefox) {
      return $_99ykra15cjk26io1m.capture(container, 'focus', handler);
    } else {
      return $_99ykra15cjk26io1m.bind(container, 'focusin', handler);
    }
  };
  var bindBlur = function (container, handler) {
    if (isFirefox) {
      return $_99ykra15cjk26io1m.capture(container, 'blur', handler);
    } else {
      return $_99ykra15cjk26io1m.bind(container, 'focusout', handler);
    }
  };
  var setup$2 = function (container, rawSettings) {
    var settings = asRawOrDie('Getting GUI events settings', settingsSchema, rawSettings);
    var pointerEvents = $_5mqjb5y3jk26imac.detect().deviceType.isTouch() ? [
      'touchstart',
      'touchmove',
      'touchend',
      'gesturestart'
    ...
    var simpleEvents = map$1(pointerEvents.concat([
      ...
      return $_99ykra15cjk26io1m.bind(container, type, function (event$$1) {
    ...
    var onKeydown = $_99ykra15cjk26io1m.bind(container, 'keydown', function (event$$1) {
    ...
    var defaultView = $_1p1gyhynjk26imd8.defaultView(container);
    var onWindowScroll = $_99ykra15cjk26io1m.bind(defaultView, 'scroll', function (event$$1) {
  ...
  var doTriggerHandler = function (lookup, eventType, rawEvent, target, source, logger) {
    ...
    return handler.fold(function () {
      ...
      if (simulatedEvent.isStopped()) {
        ...
        return $_1p1gyhynjk26imd8.parent(handlerInfo.element()).fold(function () {
  ...
  var closest$3 = function (target, transform, isRoot) {
    var delegate = $_c54u12103jk26imng.closest(target, function (elem) {
  ...
  function Registry () {
    ...
    var failOnDuplicate = function (component, tagId) {
      ...
      if (conflict === component) {
        ...
        throw new Error('The tagId "' + tagId + '" is already used by: ' + element(conflict.element()) + '\nCannot use it for: ' + element(component.element()) + '\n' + 'The conflicting element is' + ($_edbrc1yhjk26imc9.inBody(conflict.element()) ? ' ' : ' not ') + 'already in the DOM');
      }
    };
  ...
  var takeover = function (root) {
    var isAboveRoot = function (el) {
      return $_1p1gyhynjk26imd8.parent(root.element()).fold(function () {
        return true;
      }, function (parent) {
        return $_a0tnmgytjk26imdw.eq(el, parent);
      });
    };
    ...
    var systemApi = SystemApi({
      ...
      triggerFocus: function (target, originator) {
        read$2(target).fold(function () {
          $_1pdvem101jk26imn6.focus(target);
        }, function (_alloyId) {
    ...
    var addToWorld = function (component) {
      ...
      if (!$_28nlgkykjk26imd2.isText(component.element())) {
    ...
    var destroy = function () {
      domEvents.unbind();
      $_7s0cxsyzjk26imen.remove(root.element());
    };
  ...
  var READ_ONLY_MODE_CLASS = constant($_b7z5dh10tjk26imst.resolve('readonly-mode'));
  var EDIT_MODE_CLASS = constant($_b7z5dh10tjk26imst.resolve('edit-mode'));
  function OuterContainer (spec) {
    var root = build$1(Container.sketch({
      dom: { classes: [$_b7z5dh10tjk26imst.resolve('outer-container')].concat(spec.classes) },
  ...
  function AndroidRealm (scrollIntoView) {
    var alloy = OuterContainer({ classes: [$_b7z5dh10tjk26imst.resolve('android-container')] });
    var toolbar = ScrollingToolbar();
    var webapp = api$2();
    var switchToEdit = $_3jviql16jjk26iocl.makeEditSwitch(webapp);
    var socket = $_3jviql16jjk26iocl.makeSocket();
    ...
    var init = function (spec) {
      webapp.set($_gfhwpr15fjk26io25.produce(spec));
    };
    var exit = function () {
      webapp.run(function (w) {
        w.exit();
    ...
    var updateMode = function (readOnly) {
      $_3jviql16jjk26iocl.updateMode(socket, switchToEdit, readOnly, alloy.root());
    };
    return {
  ...
  var input$1 = function (parent, operation) {
    ...
    $_34bxt1116jk26imva.setAll(input, {
      opacity: '0',
      position: 'absolute',
      top: '-1000px',
      left: '-1000px'
    });
    $_7esu9pymjk26imd5.append(parent, input);
    $_1pdvem101jk26imn6.focus(input);
    operation(input);
    $_7s0cxsyzjk26imen.remove(input);
  };
  var $_b861o0173jk26iojn = { input: input$1 };
  ...
  var $_gdz3pf175jk26ioka = {
    refreshInput: refreshInput,
    refresh: refresh
  };

  var resume$1 = function (cWin, frame) {
    $_1pdvem101jk26imn6.active().each(function (active) {
      if (!$_a0tnmgytjk26imdw.eq(active, frame)) {
        $_1pdvem101jk26imn6.blur(active);
      }
    });
    cWin.focus();
    $_1pdvem101jk26imn6.focus(Element$$1.fromDom(cWin.document.body));
    $_gdz3pf175jk26ioka.refresh(cWin);
  };
  var $_wohsf174jk26iojz = { resume: resume$1 };

  var stubborn = function (outerBody, cWin, page, frame) {
    var toEditing = function () {
      $_wohsf174jk26iojz.resume(cWin, frame);
    };
    var toReading = function () {
      $_b861o0173jk26iojn.input(outerBody, $_1pdvem101jk26imn6.blur);
    };
    var captureInput = $_99ykra15cjk26io1m.bind(page, 'keydown', function (evt) {
      if (!contains([
          'input',
          'textarea'
        ], $_28nlgkykjk26imd2.name(evt.target()))) {
        toEditing();
      }
    });
  ...
  var initEvents$1 = function (editorApi, iosApi, toolstrip, socket, dropup) {
    ...
    var reposition = function () {
      var toolbarHeight = $_c1p1ek115jk26imv8.get(toolstrip);
      iosApi.run(function (api) {
    ...
    var listeners = [
      ...
      $_99ykra15cjk26io1m.bind(editorApi.doc(), 'touchend', function (touchEvent) {
        if ($_a0tnmgytjk26imdw.eq(editorApi.html(), touchEvent.target()) || $_a0tnmgytjk26imdw.eq(editorApi.body(), touchEvent.target())) {
        }
      }),
      $_99ykra15cjk26io1m.bind(toolstrip, 'transitionend', function (transitionEvent) {
        if (transitionEvent.raw().propertyName === 'height') {
          reposition();
        }
      }),
      $_99ykra15cjk26io1m.capture(toolstrip, 'touchstart', function (touchEvent) {
        saveSelectionFirst();
      ...
      tapping.onTouchmove(),
      tapping.onTouchend(),
      $_99ykra15cjk26io1m.bind(editorApi.body(), 'click', function (event) {
        event.kill();
      }),
      $_99ykra15cjk26io1m.bind(toolstrip, 'touchmove', function () {
  ...
  var $_ewtdbt176jk26ioke = { initEvents: initEvents$1 };

  function FakeSelection (win, frame) {
    var doc = win.document;
    var container = Element$$1.fromTag('div');
    $_6f40k8zujk26immd.add(container, $_b7z5dh10tjk26imst.resolve('unfocused-selections'));
    $_7esu9pymjk26imd5.append(Element$$1.fromDom(doc.documentElement), container);
    var onTouch = $_99ykra15cjk26io1m.bind(container, 'touchstart', function (event) {
      event.prevent();
      $_wohsf174jk26iojz.resume(win, frame);
      clear();
    });
    var make = function (rectangle) {
      var span = Element$$1.fromTag('span');
      $_8a5fs514mjk26int2.add(span, [
        $_b7z5dh10tjk26imst.resolve('layer-editor'),
        $_b7z5dh10tjk26imst.resolve('unfocused-selection')
      ]);
      $_34bxt1116jk26imva.setAll(span, {
    ...
    var update = function () {
      clear();
      var rectangles = $_fkzq2u15njk26io4j.getRectangles(win);
      var spans = map$1(rectangles, make);
      $_c7jzlcz0jk26imeu.append(container, spans);
    };
    var clear = function () {
      $_7s0cxsyzjk26imen.empty(container);
    };
    var destroy = function () {
      onTouch.unbind();
      $_7s0cxsyzjk26imen.remove(container);
    };
    var isActive = function () {
      return $_1p1gyhynjk26imd8.children(container).length > 0;
    };
    return {
      update: update,
      isActive: isActive,
  ...
  var $_mbhpd17gjk26iont = { findDevice: findDevice };

  var softKeyboardLimits = function (outerWindow) {
    return $_mbhpd17gjk26iont.findDevice(outerWindow.screen.width, outerWindow.screen.height);
  };
  var accountableKeyboardHeight = function (outerWindow) {
    var portrait = $_fzxbji15bjk26io17.get(outerWindow).isPortrait();
  ...
  var getGreenzone = function (socket, dropup) {
    var outerWindow = $_1p1gyhynjk26imd8.owner(socket).dom().defaultView;
    var viewportHeight = $_c1p1ek115jk26imv8.get(socket) + $_c1p1ek115jk26imv8.get(dropup);
  ...
  var updatePadding = function (contentBody, socket, dropup) {
    ...
    var deltaHeight = $_c1p1ek115jk26imv8.get(socket) + $_c1p1ek115jk26imv8.get(dropup) - greenzoneHeight;
    $_34bxt1116jk26imva.set(contentBody, 'padding-bottom', deltaHeight + 'px');
  };
  var $_3gyggo17fjk26ionk = {
  ...
  var yFixedData = 'data-' + $_b7z5dh10tjk26imst.resolve('position-y-fixed');
  var yFixedProperty = 'data-' + $_b7z5dh10tjk26imst.resolve('y-property');
  var yScrollingData = 'data-' + $_b7z5dh10tjk26imst.resolve('scrolling');
  var windowSizeData = 'data-' + $_b7z5dh10tjk26imst.resolve('last-window-height');
  var getYFixedData = function (element) {
    return $_47wscg15mjk26io4h.safeParse(element, yFixedData);
  };
  var getYFixedProperty = function (element) {
    return $_a03svjzwjk26immh.get(element, yFixedProperty);
  };
  var getLastWindowSize = function (element) {
    return $_47wscg15mjk26io4h.safeParse(element, windowSizeData);
  };
  ...
  var classify = function (element) {
    ...
    var classifier = $_a03svjzwjk26immh.get(element, yScrollingData) === 'true' ? classifyScrolling : classifyFixed;
    return classifier(element, offsetY);
  };
  var findFixtures = function (container) {
    var candidates = $_1roeab119jk26imw0.descendants(container, '[' + yFixedData + ']');
    return map$1(candidates, classify);
  };
  var takeoverToolbar = function (toolbar) {
    var oldToolbarStyle = $_a03svjzwjk26immh.get(toolbar, 'style');
    $_34bxt1116jk26imva.setAll(toolbar, {
      position: 'absolute',
      top: '0px'
    });
    $_a03svjzwjk26immh.set(toolbar, yFixedData, '0px');
    $_a03svjzwjk26immh.set(toolbar, yFixedProperty, 'top');
    var restore = function () {
      $_a03svjzwjk26immh.set(toolbar, 'style', oldToolbarStyle || '');
      $_a03svjzwjk26immh.remove(toolbar, yFixedData);
      $_a03svjzwjk26immh.remove(toolbar, yFixedProperty);
    };
    return { restore: restore };
  };
  var takeoverViewport = function (toolbarHeight, height, viewport) {
    var oldViewportStyle = $_a03svjzwjk26immh.get(viewport, 'style');
    $_l0ct2159jk26io0s.register(viewport);
    $_34bxt1116jk26imva.setAll(viewport, {
      position: 'absolute',
      height: height + 'px',
      width: '100%',
      top: toolbarHeight + 'px'
    });
    $_a03svjzwjk26immh.set(viewport, yFixedData, toolbarHeight + 'px');
    $_a03svjzwjk26immh.set(viewport, yScrollingData, 'true');
    $_a03svjzwjk26immh.set(viewport, yFixedProperty, 'top');
    var restore = function () {
      $_l0ct2159jk26io0s.deregister(viewport);
      $_a03svjzwjk26immh.set(viewport, 'style', oldViewportStyle || '');
      $_a03svjzwjk26immh.remove(viewport, yFixedData);
      $_a03svjzwjk26immh.remove(viewport, yScrollingData);
      $_a03svjzwjk26immh.remove(viewport, yFixedProperty);
    };
    return { restore: restore };
  };
  var takeoverDropup = function (dropup, toolbarHeight, viewportHeight) {
    var oldDropupStyle = $_a03svjzwjk26immh.get(dropup, 'style');
    $_34bxt1116jk26imva.setAll(dropup, {
      position: 'absolute',
      bottom: '0px'
    });
    $_a03svjzwjk26immh.set(dropup, yFixedData, '0px');
    $_a03svjzwjk26immh.set(dropup, yFixedProperty, 'bottom');
    var restore = function () {
      $_a03svjzwjk26immh.set(dropup, 'style', oldDropupStyle || '');
      $_a03svjzwjk26immh.remove(dropup, yFixedData);
      $_a03svjzwjk26immh.remove(dropup, yFixedProperty);
    };
    return { restore: restore };
  };
  var deriveViewportHeight = function (viewport, toolbarHeight, dropupHeight) {
    var outerWindow = $_1p1gyhynjk26imd8.owner(viewport).dom().defaultView;
    var winH = outerWindow.innerHeight;
    $_a03svjzwjk26immh.set(viewport, windowSizeData, winH + 'px');
    return winH - toolbarHeight - dropupHeight;
  };
  var takeover$1 = function (viewport, contentBody, toolbar, dropup) {
    var outerWindow = $_1p1gyhynjk26imd8.owner(viewport).dom().defaultView;
    var toolbarSetup = takeoverToolbar(toolbar);
    var toolbarHeight = $_c1p1ek115jk26imv8.get(toolbar);
    var dropupHeight = $_c1p1ek115jk26imv8.get(dropup);
    ...
    var refresh = function () {
      if (isActive) {
        var newToolbarHeight = $_c1p1ek115jk26imv8.get(toolbar);
        var dropupHeight_1 = $_c1p1ek115jk26imv8.get(dropup);
        var newHeight = deriveViewportHeight(viewport, newToolbarHeight, dropupHeight_1);
        $_a03svjzwjk26immh.set(viewport, yFixedData, newToolbarHeight + 'px');
        $_34bxt1116jk26imva.set(viewport, 'height', newHeight + 'px');
        $_34bxt1116jk26imva.set(dropup, 'bottom', -(newToolbarHeight + newHeight + dropupHeight_1) + 'px');
        $_3gyggo17fjk26ionk.updatePadding(contentBody, viewport, dropup);
      }
    };
    var setViewportOffset = function (newYOffset) {
      var offsetPx = newYOffset + 'px';
      $_a03svjzwjk26immh.set(viewport, yFixedData, offsetPx);
      refresh();
    };
    $_3gyggo17fjk26ionk.updatePadding(contentBody, viewport, dropup);
    return {
  ...
  var $_ezzomx17ejk26iomz = {
    findFixtures: findFixtures,
    takeover: takeover$1,
    getYFixedData: getYFixedData
  };

  var animator = $_796jsv17djk26iomu.create();
  var ANIMATION_STEP = 15;
  var NUM_TOP_ANIMATION_FRAMES = 10;
  var ANIMATION_RATE = 10;
  var lastScroll = 'data-' + $_b7z5dh10tjk26imst.resolve('last-scroll-top');
  var getTop = function (element) {
    var raw = $_34bxt1116jk26imva.getRaw(element, 'top').getOr('0');
  ...
  var moveScrollAndTop = function (element, destination, finalTop) {
    return Future.nu(function (callback) {
      ...
      var update = function (newScroll) {
        ...
        $_34bxt1116jk26imva.set(element, 'top', getTop(element) + ANIMATION_STEP + 'px');
      };
      var finish = function () {
        element.dom().scrollTop = destination;
        $_34bxt1116jk26imva.set(element, 'top', finalTop + 'px');
  ...
  var moveOnlyScroll = function (element, destination) {
    return Future.nu(function (callback) {
      var getCurrent = curry(getScrollTop, element);
      $_a03svjzwjk26immh.set(element, lastScroll, getCurrent());
      var update = function (newScroll, abort) {
        var previous = $_47wscg15mjk26io4h.safeParse(element, lastScroll);
        if (previous !== element.dom().scrollTop) {
          abort(element.dom().scrollTop);
        } else {
          element.dom().scrollTop = newScroll;
          $_a03svjzwjk26immh.set(element, lastScroll, newScroll);
        }
      };
      var finish = function () {
        element.dom().scrollTop = destination;
        $_a03svjzwjk26immh.set(element, lastScroll, destination);
        callback(destination);
      };
  ...
  var moveOnlyTop = function (element, destination) {
    return Future.nu(function (callback) {
      ...
      var update = function (newTop) {
        $_34bxt1116jk26imva.set(element, 'top', newTop + 'px');
      };
      var finish = function () {
        update(destination);
        callback(destination);
  ...
  var updateTop = function (element, amount) {
    var newTop = amount + $_ezzomx17ejk26iomz.getYFixedData(element) + 'px';
    $_34bxt1116jk26imva.set(element, 'top', newTop);
  };
  var moveWindowScroll = function (toolbar, viewport, destY) {
    var outerWindow = $_1p1gyhynjk26imd8.owner(toolbar).dom().defaultView;
    return Future.nu(function (callback) {
  ...
  var scrollIntoView = function (cWin, socket, dropup, top, bottom) {
    var greenzone = $_3gyggo17fjk26ionk.getGreenzone(socket, dropup);
    var refreshCursor = curry($_gdz3pf175jk26ioka.refresh, cWin);
    if (top > greenzone || bottom > greenzone) {
      $_au6gym179jk26iom5.moveOnlyScroll(socket, socket.dom().scrollTop - greenzone + bottom).get(refreshCursor);
    } else if (top < 0) {
      $_au6gym179jk26iom5.moveOnlyScroll(socket, socket.dom().scrollTop + top).get(refreshCursor);
    } else {
    }
  };
  var $_6pk61417ijk26ioo5 = { scrollIntoView: scrollIntoView };
  ...
  var updateFixed = function (element, property, winY, offsetY) {
    ...
    $_34bxt1116jk26imva.set(element, property, destination + 'px');
    return Future.pure(offsetY);
  };
  var updateScrollingFixed = function (element, winY, offsetY) {
    var destTop = winY + offsetY;
    var oldProp = $_34bxt1116jk26imva.getRaw(element, 'top').getOr(offsetY);
    var delta = destTop - parseInt(oldProp, 10);
    var destScroll = element.dom().scrollTop + delta;
    return $_au6gym179jk26iom5.moveScrollAndTop(element, destScroll, destTop);
  };
  ...
  var register$2 = function (toolstrip, socket, container, outerWindow, structure, cWin) {
    ...
    var scrollThrottle = last$3(function () {
      scroller.idle(function () {
        $_1ol6fa17jjk26iooa.updatePositions(container, outerWindow.pageYOffset).get(function () {
    ...
    var onScroll = $_99ykra15cjk26io1m.bind(Element$$1.fromDom(outerWindow), 'scroll', function () {
      if (outerWindow.pageYOffset < 0) {
        return;
      }
      scrollThrottle.throttle();
    });
    $_1ol6fa17jjk26iooa.updatePositions(container, outerWindow.pageYOffset).get(identity);
  ...
  var setup$3 = function (bag) {
    ...
    var structure = $_ezzomx17ejk26iomz.takeover(socket, ceBody, toolstrip, dropup);
    var keyboardModel = keyboardType(bag.outerBody(), cWin, $_edbrc1yhjk26imc9.body(), contentElement, toolstrip, toolbar);
    var toEditing = function () {
    ...
    var onOrientation = $_fzxbji15bjk26io17.onChange(outerWindow, {
      onChange: noop,
    ...
    var scrollIntoView = function (top, bottom) {
      $_6pk61417ijk26ioo5.scrollIntoView(cWin, socket, dropup, top, bottom);
    };
    var syncHeight = function () {
      $_34bxt1116jk26imva.set(contentElement, 'height', contentElement.dom().contentWindow.document.body.scrollHeight + 'px');
    };
    var setViewportOffset = function (newYOffset) {
      structure.setViewportOffset(newYOffset);
      $_au6gym179jk26iom5.moveOnlyTop(socket, newYOffset).get(identity);
    };
    var destroy = function () {
      structure.restore();
      ...
      $_b861o0173jk26iojn.input($_edbrc1yhjk26imc9.body(), $_1pdvem101jk26imn6.blur);
    };
    return {
      toEditing: toEditing,
      toReading: toReading,
  ...
  var $_438ibk177jk26iokt = { setup: setup$3 };
  ...
  var create$8 = function (platform, mask) {
    ...
    var enter = function () {
      ...
      $_f7wr9d167jk26io8g.getActiveApi(platform.editor).each(function (editorApi) {
        priorState.set({
          socketHeight: $_34bxt1116jk26imva.getRaw(platform.socket, 'height'),
          iframeHeight: $_34bxt1116jk26imva.getRaw(editorApi.frame(), 'height'),
          outerScroll: document.body.scrollTop
        });
        scrollEvents.set({ exclusives: $_dkrdny16ijk26ioc8.exclusive(doc, '.' + $_l0ct2159jk26io0s.scrollable()) });
        $_6f40k8zujk26immd.add(platform.container, $_b7z5dh10tjk26imst.resolve('fullscreen-maximized'));
        $_c8t6pz168jk26io8w.clobberStyles(platform.container, editorApi.body());
        meta.maximize();
        $_34bxt1116jk26imva.set(platform.socket, 'overflow', 'scroll');
        $_34bxt1116jk26imva.set(platform.socket, '-webkit-overflow-scrolling', 'touch');
        $_1pdvem101jk26imn6.focus(editorApi.body());
        ...
        iosApi.set($_438ibk177jk26iokt.setup(setupBag({
          cWin: editorApi.win(),
          ...
          keyboardType: $_av3lx6172jk26ioj9.stubborn,
        ...
        iosEvents.set($_ewtdbt176jk26ioke.initEvents(editorApi, iosApi, platform.toolstrip, platform.socket, platform.dropup));
      });
    };
    var exit = function () {
      meta.restore();
      ...
      priorState.on(function (s) {
        s.socketHeight.each(function (h) {
          $_34bxt1116jk26imva.set(platform.socket, 'height', h);
        });
        s.iframeHeight.each(function (h) {
          $_34bxt1116jk26imva.set(platform.editor.getFrame(), 'height', h);
        });
      ...
      $_6f40k8zujk26immd.remove(platform.container, $_b7z5dh10tjk26imst.resolve('fullscreen-maximized'));
      $_c8t6pz168jk26io8w.restoreStyles();
      $_l0ct2159jk26io0s.deregister(platform.toolbar);
      $_34bxt1116jk26imva.remove(platform.socket, 'overflow');
      $_34bxt1116jk26imva.remove(platform.socket, '-webkit-overflow-scrolling');
      $_1pdvem101jk26imn6.blur(platform.editor.getFrame());
      $_f7wr9d167jk26io8g.getActiveApi(platform.editor).each(function (editorApi) {
  ...
  var $_e8qdar171jk26ioip = { create: create$8 };

  var produce$1 = function (raw) {
    var mobile = asRawOrDie('Getting IosWebapp schema', MobileSchema, raw);
    $_34bxt1116jk26imva.set(mobile.toolstrip, 'width', '100%');
    $_34bxt1116jk26imva.set(mobile.container, 'position', 'relative');
    var onView = function () {
      mobile.setReadOnly(mobile.readOnlyOnInit());
      mode.enter();
    };
    var mask = build$1($_8bpqjl16ajk26io9j.sketch(onView, mobile.translate));
    mobile.alloy.add(mask);
    var maskApi = {
      show: function () {
        mobile.alloy.add(mask);
    ...
    var mode = $_e8qdar171jk26ioip.create(mobile, maskApi);
    return {
      setReadOnly: mobile.setReadOnly,
  ...
  var $_fdj05h170jk26ioif = { produce: produce$1 };

  function IosRealm (scrollIntoView) {
    var alloy = OuterContainer({ classes: [$_b7z5dh10tjk26imst.resolve('ios-container')] });
    var toolbar = ScrollingToolbar();
    var webapp = api$2();
    var switchToEdit = $_3jviql16jjk26iocl.makeEditSwitch(webapp);
    var socket = $_3jviql16jjk26iocl.makeSocket();
    ...
    var init = function (spec) {
      webapp.set($_fdj05h170jk26ioif.produce(spec));
    };
    var exit = function () {
      webapp.run(function (w) {
        Replacing.remove(socket, switchToEdit);
  ...
  var $_28j01w17mjk26ioop = { derive: derive$4 };
  ...
  var fireChange$1 = function (realm, command, state) {
    realm.system().broadcastOn([$_7t51r1109jk26imo8.formatChanged()], {
      command: command,
      state: state
    });
  };
  ...
  var $_bmiw5r17pjk26iop0 = { fireSkinLoaded: fireSkinLoaded };

  var READING = constant('toReading');
  var EDITING = constant('toEditing');
  global$1.add('mobile', function (editor) {
    var renderUI = function (args) {
      var cssUrls = $_28j01w17mjk26ioop.derive(editor);
      if (isSkinDisabled(editor) === false) {
        editor.contentCSS.push(cssUrls.content);
        global.DOM.styleSheetLoader.load(cssUrls.ui, $_bmiw5r17pjk26iop0.fireSkinLoaded(editor));
      } else {
        $_bmiw5r17pjk26iop0.fireSkinLoaded(editor)();
      }
      var doScrollIntoView = function () {
        editor.fire('scrollIntoView');
      };
      var wrapper = Element$$1.fromTag('div');
      var realm = $_5mqjb5y3jk26imac.detect().os.isAndroid() ? AndroidRealm(doScrollIntoView) : IosRealm(doScrollIntoView);
      var original = Element$$1.fromDom(args.targetNode);
      $_7esu9pymjk26imd5.after(original, wrapper);
      attachSystem(wrapper, realm.system());
      var findFocusIn = function (elem) {
        return $_1pdvem101jk26imn6.search(elem).bind(function (focused) {
          return realm.system().getByDom(focused).toOption();
        });
      };
      var outerWindow = args.targetNode.ownerDocument.defaultView;
      var orientation = $_fzxbji15bjk26io17.onChange(outerWindow, {
        onChange: function () {
          var alloy = realm.system();
          alloy.broadcastOn([$_7t51r1109jk26imo8.orientationChanged()], { width: $_fzxbji15bjk26io17.getActualWidth(outerWindow) });
        },
        onReady: noop
      });
      ...
      editor.on('init', function () {
        realm.init({
          editor: {
            ...
            onTouchContent: function () {
              var toolbar = Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_b7z5dh10tjk26imst.resolve('toolbar')));
            ...
            onTapContent: function (evt) {
              ...
              if ($_28nlgkykjk26imd2.name(target) === 'img') {
                editor.selection.select(target.dom());
                evt.kill();
              } else if ($_28nlgkykjk26imd2.name(target) === 'a') {
                var component = realm.system().getByDom(Element$$1.fromDom(editor.editorContainer));
                component.each(function (container) {
                  if (Swapping.isAlpha(container)) {
                    $_53s8lv107jk26imo3.openLink(target.dom());
                  }
                });
              }
            }
          ...
          toolstrip: Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_b7z5dh10tjk26imst.resolve('toolstrip'))),
          toolbar: Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_b7z5dh10tjk26imst.resolve('toolbar'))),
          dropup: realm.dropup(),
          alloy: realm.system(),
          translate: noop,
        ...
        var hideDropup = function () {
          realm.dropup().disappear(function () {
            realm.system().broadcastOn([$_7t51r1109jk26imo8.dropupDismissed()], {});
          });
        };
        var backToMaskGroup = {
          label: 'The first group',
          scrollable: false,
          items: [$_eugz1f10ujk26imsw.forToolbar('back', function () {
              editor.selection.collapse();
              realm.exit();
            }, {})]
        };
        var backToReadOnlyGroup = {
          ...
          scrollable: false,
          items: [$_eugz1f10ujk26imsw.forToolbar('readonly-back', function () {
        ...
        var features = $_2mrk6210ajk26imoc.setup(realm, editor);
        var items = $_2mrk6210ajk26imoc.detect(editor.settings, features);
        var actionGroup = {
        ...
        $_8ien2a17ojk26ioot.init(realm, editor);
      });
      return {
