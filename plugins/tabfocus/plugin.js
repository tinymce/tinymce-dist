...
var tabfocus = (function () {
  ...
  var $_5piwnejcjcq86j66 = { getTabFocus: getTabFocus };
  ...
  var setup = function (editor) {
    function tabHandler(e) {
      ...
      v = Tools.explode($_5piwnejcjcq86j66.getTabFocus(editor));
      if (v.length === 1) {
        v[1] = v[0];
        v[0] = ':prev';
      }
  ...
  var $_3qlpwkj5jcq86j62 = { setup: setup };

  PluginManager.add('tabfocus', function (editor) {
    $_3qlpwkj5jcq86j62.setup(editor);
  });
  var Plugin = function () {
  };
