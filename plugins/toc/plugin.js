...
var toc = (function () {
  ...
  var $_cmwd2fqyje4c0kdm = { create: create };

  var tocId = $_cmwd2fqyje4c0kdm.create('mcetoc_');
  ...
  var readHeaders = function (editor) {
    var tocClass = $_56n7saqxje4c0kdh.getTocClass(editor);
    var headerTag = $_56n7saqxje4c0kdh.getTocHeader(editor);
    var selector = generateSelector($_56n7saqxje4c0kdh.getTocDepth(editor));
  ...
  var generateTocHtml = function (editor) {
    ...
    return '<div class="' + editor.dom.encode($_56n7saqxje4c0kdh.getTocClass(editor)) + '" contenteditable="false">' + html + '</div>';
  };
  var generateTocContentHtml = function (editor) {
    ...
    html += generateTitle($_56n7saqxje4c0kdh.getTocHeader(editor), I18n.translate('Table of Contents'));
    for (i = 0; i < headers.length; i++) {
      h = headers[i];
      h.element.id = h.id;
  ...
  var register = function (editor) {
    editor.addCommand('mceInsertToc', function () {
      $_3hcft0qtje4c0kdb.insertToc(editor);
    });
    editor.addCommand('mceUpdateToc', function () {
      $_3hcft0qtje4c0kdb.updateToc(editor);
    });
  };
  var $_tq8ykqsje4c0kd5 = { register: register };

  var setup = function (editor) {
    var $ = editor.$, tocClass = $_56n7saqxje4c0kdh.getTocClass(editor);
  ...
  var $_8xhss4qzje4c0kdo = { setup: setup };

  var toggleState = function (editor) {
    return function (e) {
      var ctrl = e.control;
      editor.on('LoadContent SetContent change', function () {
        ctrl.disabled(editor.readonly || !$_3hcft0qtje4c0kdb.hasHeaders(editor));
      });
    };
  };
  var isToc = function (editor) {
    return function (elm) {
      return elm && editor.dom.is(elm, '.' + $_56n7saqxje4c0kdh.getTocClass(editor)) && editor.getBody().contains(elm);
    };
  };
  ...
  var $_frav9ir0je4c0kdq = { register: register$1 };

  PluginManager.add('toc', function (editor) {
    $_tq8ykqsje4c0kd5.register(editor);
    $_frav9ir0je4c0kdq.register(editor);
    $_8xhss4qzje4c0kdo.setup(editor);
  });
  function Plugin () {
  }
