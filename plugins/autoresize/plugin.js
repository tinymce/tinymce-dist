...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_4bgx5693jjgw5l8d.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_4bgx5693jjgw5l8d.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_4bgx5693jjgw5l8d.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_4bgx5693jjgw5l8d.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_4bgx5693jjgw5l8d.getAutoResizeBottomMargin(editor);
    ...
    if ($_4bgx5693jjgw5l8d.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_eiwfzo90jjgw5l89.resize(editor, oldSize);
    });
  };
  var $_b28f878zjjgw5l88 = { register: register };

  global.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_b28f878zjjgw5l88.register(editor, oldSize);
      $_eiwfzo90jjgw5l89.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
