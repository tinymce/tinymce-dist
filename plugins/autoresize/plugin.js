...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_di8ewf92jm0o6aqm.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_di8ewf92jm0o6aqm.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_di8ewf92jm0o6aqm.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_di8ewf92jm0o6aqm.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_di8ewf92jm0o6aqm.getAutoResizeBottomMargin(editor);
    ...
    if ($_di8ewf92jm0o6aqm.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_4dyt4e8zjm0o6aqi.resize(editor, oldSize);
    });
  };
  var $_10i2a58yjm0o6aqh = { register: register };

  global.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_10i2a58yjm0o6aqh.register(editor, oldSize);
      $_4dyt4e8zjm0o6aqi.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
