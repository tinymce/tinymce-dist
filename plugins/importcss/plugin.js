...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_5lb7rjdwjcq86in0.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_5lb7rjdwjcq86in0.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_5lb7rjdwjcq86in0.getSelectorConverter(editor)) {
      selectorConverter = $_5lb7rjdwjcq86in0.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_5lb7rjdwjcq86in0.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_5lb7rjdwjcq86in0.getCssGroups(editor));
      ...
      if (!$_5lb7rjdwjcq86in0.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      Tools.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_5lb7rjdwjcq86in0.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_bsb0dndrjcq86imu.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_5pfs4adqjcq86imr = { get: get };

  PluginManager.add('importcss', function (editor) {
    $_bsb0dndrjcq86imu.setup(editor);
    return $_5pfs4adqjcq86imr.get(editor);
  });
  var Plugin = function () {
  };
